...
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='01' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='01' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='02' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='02' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='03' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='03' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='04' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='04' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='05' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='05' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='06' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='06' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='07' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='07' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='08' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='08' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='09' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='09' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='10' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='10' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='11' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='11' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT*FROM (
SELECT no_coa coa_no,sum(ROUND(debit*rate,2)) debit_idr,sum(ROUND(credit*rate,2)) credit_idr FROM tbl_list_journal WHERE tgl_journal BETWEEN (
SELECT tgl_awal FROM tbl_tgl_tb WHERE bulan='12' AND tahun='$tahun_akhir') AND (
SELECT tgl_akhir FROM tbl_tgl_tb WHERE bulan='12' AND tahun='$tahun_akhir') GROUP BY id) a INNER JOIN (
...
SELECT no_coa,id_indirect FROM mastercoa_v2) b ON b.no_coa=a.coa_no) a GROUP BY a.id_indirect) a) des ON des.id_indirect12=cf.id) a where a.id IN ('27','28') ORDER BY a.id asc");
        ...
        <tr>
            ...
            <?php 
                $sql = mysqli_query($conn2,"select id,ind_name,if($tahun_awal = '2023',2910197113.18,saldo_jan) saldo_jan,saldo_feb,saldo_mar,saldo_apr,saldo_may,saldo_jun,saldo_jul,saldo_aug,saldo_sep,saldo_oct,saldo_nov,saldo_dec FROM (
SELECT*FROM (
SELECT id,ind_name FROM tbl_master_cashflow) cf LEFT JOIN (
SELECT*FROM (
SELECT id_indirect,((sum(debit_idr)-sum(credit_idr))*-1) saldo_jan FROM (
...
SELECT no_coa,id_indirect FROM mastercoa_v2) b ON b.no_coa=a.coa_no) a GROUP BY a.id_indirect) a) des ON des.id_indirect12=cf.id) a where a.id = '30' ORDER BY a.id asc");
        ...
        <tr>
            ...
            <?php 
                $sql = mysqli_query($conn2,"select id,ind_name,if($tahun_awal = '2023',(sum(saldo_jan) - 49264896939.97),sum(saldo_jan)) saldo_jan,sum(saldo_feb) saldo_feb,sum(saldo_mar) saldo_mar,sum(saldo_apr) saldo_apr,sum(saldo_may) saldo_may,sum(saldo_jun) saldo_jun,sum(saldo_jul) saldo_jul,sum(saldo_aug) saldo_aug,sum(saldo_sep) saldo_sep,sum(saldo_oct) saldo_oct,sum(saldo_nov) saldo_nov,sum(saldo_dec) saldo_dec FROM (
SELECT*FROM (
SELECT id,ind_name FROM tbl_master_cashflow) cf LEFT JOIN (
SELECT*FROM (
SELECT id_indirect,((sum(debit_idr)-sum(credit_idr))*-1) saldo_jan FROM (
...
(select no_coa nocoa,jan_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,jan_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and jan_$tahun_akhir > 0 OR no_coa = '1.10.02' and jan_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '01' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '01' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) jan on jan.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_feb from 
(select no_coa nocoa,feb_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,feb_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and feb_$tahun_akhir > 0 OR no_coa = '1.10.02' and feb_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '02' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '02' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) feb on feb.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_mar from 
(select no_coa nocoa,mar_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,mar_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and mar_$tahun_akhir > 0 OR no_coa = '1.10.02' and mar_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '03' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '03' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) mar on mar.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_apr from 
(select no_coa nocoa,apr_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,apr_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and apr_$tahun_akhir > 0 OR no_coa = '1.10.02' and apr_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '04' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '04' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) apr on apr.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_may from 
(select no_coa nocoa,may_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,may_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and may_$tahun_akhir > 0 OR no_coa = '1.10.02' and may_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '05' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '05' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) may on may.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_jun from 
(select no_coa nocoa,jun_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,jun_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and jun_$tahun_akhir > 0 OR no_coa = '1.10.02' and jun_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '06' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '06' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) jun on jun.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_jul from 
(select no_coa nocoa,jul_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,jul_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and jul_$tahun_akhir > 0 OR no_coa = '1.10.02' and jul_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '07' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '07' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) jul on jul.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_aug from 
(select no_coa nocoa,aug_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,aug_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and aug_$tahun_akhir > 0 OR no_coa = '1.10.02' and aug_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '08' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '08' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) aug on aug.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_sep from 
(select no_coa nocoa,sep_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,sep_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and sep_$tahun_akhir > 0 OR no_coa = '1.10.02' and sep_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '09' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '09' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) sep on sep.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_oct from 
(select no_coa nocoa,oct_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,oct_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and oct_$tahun_akhir > 0 OR no_coa = '1.10.02' and oct_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '10' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '10' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) oct on oct.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_nov from 
(select no_coa nocoa,nov_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,nov_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and nov_$tahun_akhir > 0 OR no_coa = '1.10.02' and nov_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '11' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '11' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) nov on nov.coa_no = coa.no_coa left join

(select nocoa coa_no, (saldo ) saldo_dec from 
(select no_coa nocoa,dec_$tahun_akhir as saldo from saldo_awal_tb where no_coa != '1.10.01' and no_coa != '1.10.02' UNION select no_coa nocoa,dec_2024 as saldo from saldo_awal_tb where no_coa = '1.10.01' and dec_$tahun_akhir > 0 OR no_coa = '1.10.02' and dec_$tahun_akhir > 0) saldo
left join
(select no_coa coa_no,sum(ROUND(credit * rate,2)) credit_idr,sum(ROUND(debit * rate,2)) debit_idr  from tbl_list_journal where tgl_journal BETWEEN (select tgl_awal from tbl_tgl_tb where bulan = '12' and tahun = '$tahun_akhir') and (select tgl_akhir from tbl_tgl_tb where bulan = '12' and tahun = '$tahun_akhir') group by no_coa) 
jnl on jnl.coa_no = saldo.nocoa order by nocoa asc) des on des.coa_no = coa.no_coa 
