...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        $.ajax({
            ...
            data: {'doc_num':doc_num, 'tgl_penerimaan':tgl_penerimaan, 'unik_code':unik_code, 'nama_supp':nama_supp, 'deskripsi':deskripsi, 'total_amount':total_amount, 'create_user':create_user},
            cache: 'false',
            close: function(e){
                e.preventDefault();
            },
