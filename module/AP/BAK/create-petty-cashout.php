                        ...
                        $(" #select input[type=checkbox]:checked").each(function () {
                            ...
                            if(amount != '' && nama_supp != '' && akun != '' && balance == '0' && debit != '' || amount != '' && nama_supp != '' && akun != '' && balance == '0' && credit != '' || refer == 'Settlement' && nama_supp != '' && akun != '' && balance == '0' && debit != '' || refer == 'Settlement' && nama_supp != '' && akun != '' && balance == '0' && credit != ''){   
                                $.ajax({
                                    ...
                                    data: {'no_pco':no_pco, 'tgl_pco':tgl_pco, 'reff_doc':reff_doc, 'no_coa':no_coa, 'no_costcntr':no_costcntr, 'buyer':buyer, 'no_ws':no_ws, 'curr':curr, 'debit':debit, 'credit':credit, 'deskripsi':deskripsi, 'oth_doc':oth_doc},
                                    cache: 'false',
                                    close: function(e){
                                        e.preventDefault();
                                    },
