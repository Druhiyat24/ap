...
VALUES 
   ('$kode', '$tgl_pco', '$type_co', '$no_coa', '$nama_coa', '$no_costcntr', '$nama_cc', '$txtno_pco', '$txttgl_pco', '$buyer', '$no_ws', '$curr', '1', '$debit', '$credit', '$debit', '$credit', 'Draft', '$deskripsi', '$create_by', '$create_date', '', '', '', '')";
