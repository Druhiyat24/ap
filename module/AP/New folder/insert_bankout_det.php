...
if ($no_pay == '') {
	...
	while ($row = mysqli_fetch_assoc($sqlpv)) {
		...
		$ttl_per_row = $pv_per_total / 100 * $dpp_pv_real;

		$ttl_dpp_per_row = $pv_per_dpp / 100 * $ttl_per_row;
		$ttl_pph_per_row = $pv_per_pph / 100 * $ttl_per_row;
		$ttl_ppn_per_row = $pv_per_ppn / 100 * $ttl_per_row;
		$total_dppnya = $ttl_dpp_per_row + $ttl_ppn_per_row + $ttl_pph_per_row;
