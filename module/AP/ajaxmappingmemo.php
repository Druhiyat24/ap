...
$id_sub = isset($_POST['id_sub']) ? $_POST['id_sub']: null;
    ...
    $sql = mysqli_query($conn1,"select a.id,jns_trans,ditagihkan,id_ctg,nm_ctg,id_sub_ctg,nm_sub_ctg,id_item,item_name,no_coa,nama_coa,id_cc,cc_name, nama_pc from memo_mapping_v2 a inner join master_pc b on b.kode_pc = a.profit_center where id_sub_ctg = '$id_sub'");
