...
$q_sum_total_idr = mysqli_query($conn2, $sql_sum_total_idr);
$footer_sum_idr = mysqli_fetch_assoc($q_sum_total_idr);
...
$q_sum_total_usd = mysqli_query($conn2, $sql_sum_total_usd);
$footer_sum_usd = mysqli_fetch_assoc($q_sum_total_usd);
...
$q_sum_total_all = mysqli_query($conn2, $sql_sum_total_all);
$footer_sum_all = mysqli_fetch_assoc($q_sum_total_all);
...
echo json_encode([
    ...
    "footer_sum_idr" => $footer_sum_idr,
    "footer_sum_usd" => $footer_sum_usd,
    "footer_sum_all" => $footer_sum_all
]);