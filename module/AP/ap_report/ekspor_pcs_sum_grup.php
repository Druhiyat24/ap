...
<body>
    ...
    header("Content-Disposition: attachment; filename=AP Report - SUMMARY.xls");
    ...
    <h4> Payable Card Statement - SUMMARY<br/> PERIODE: <?php echo $start_date; ?> - <?php echo $end_date; ?></h4>
    ...
    <table style="width:100%;font-size:10px;" border="1" width="100%">
        ...
        ?>
            ...
            <tr>
    <th colspan="5" style="background:white;text-align:left;">GROUP</th>
...
CASE
    ...
    (
        ...
        ROUND(SUM(saldo_akhir_idr),2) saldo_akhir_idr,
                ...
                ROUND(SUM(pro_due4),2) pro_due4,
                ROUND(SUM(pro_due5),2) pro_due5,
                ROUND(SUM(tot_produe),2) tot_produe FROM (select item_type2, curr, IF(CURR = 'usd', saldo_akhir, 0) saldo_akhir, saldo_akhir_idr, due_current, due_1_30, due_31_60, due_61_90, due_gt_360, due_91_120, due_121_180, due_181_360, total_due, pro_due2, pro_due, pro_due0, pro_due1, pro_due3, pro_due4, pro_due5, tot_produe from bpb
        UNION ALL
        select item_type2, curr, IF(CURR = 'usd', saldo_akhir, 0) saldo_akhir, saldo_akhir_idr, due_current, due_1_30, due_31_60, due_61_90, due_91_120, due_121_180, due_181_360, due_gt_360, total_due, pro_due, pro_due0, pro_due1, pro_due2, pro_due3, pro_due4, pro_due5, tot_produe from kontrabon
        UNION ALL
...
while($row_idr = mysqli_fetch_array($sql_idr_grup)){

    echo '<tr style="font-size:12px;">
            <th colspan = "3" style="text-align: center;vertical-align: middle;">Total IDR</th> 
            <th style="text-align:right;" value="'.$row_idr['saldo_akhir'].'">'.number_format($row_idr['saldo_akhir'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['saldo_akhir_idr'].'">'.number_format($row_idr['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_idr['due_current'].'">'.number_format($row_idr['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['due_1_30'].'">'.number_format($row_idr['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['due_31_60'].'">'.number_format($row_idr['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['due_61_90'].'">'.number_format($row_idr['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['due_91_120'].'">'.number_format($row_idr['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['due_121_180'].'">'.number_format($row_idr['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['due_181_360'].'">'.number_format($row_idr['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['due_gt_360'].'">'.number_format($row_idr['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['total_due'].'">'.number_format($row_idr['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_idr['pro_due'].'">'.number_format($row_idr['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['pro_due0'].'">'.number_format($row_idr['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['pro_due1'].'">'.number_format($row_idr['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['pro_due2'].'">'.number_format($row_idr['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['pro_due3'].'">'.number_format($row_idr['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['pro_due4'].'">'.number_format($row_idr['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['pro_due5'].'">'.number_format($row_idr['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr['tot_produe'].'">'.number_format($row_idr['tot_produe'],2).'</th>                                                             
        </tr>
    ';
...
$sql_usd_grup = mysqli_query($conn2,"
SELECT
    SUM(saldo_akhir) saldo_akhir,
    SUM(saldo_akhir_idr) saldo_akhir_idr,
    SUM(due_current) due_current,
...
while($row_usd_grup = mysqli_fetch_array($sql_usd_grup)){

    echo '<tr style="font-size:12px;">
            <th colspan = "3" style="text-align: center;vertical-align: middle;">Total USD</th> 
            <th style="text-align:right;" value="'.$row_usd_grup['saldo_akhir'].'">'.number_format($row_usd_grup['saldo_akhir'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['saldo_akhir_idr'].'">'.number_format($row_usd_grup['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_usd_grup['due_current'].'">'.number_format($row_usd_grup['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['due_1_30'].'">'.number_format($row_usd_grup['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['due_31_60'].'">'.number_format($row_usd_grup['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['due_61_90'].'">'.number_format($row_usd_grup['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['due_91_120'].'">'.number_format($row_usd_grup['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['due_121_180'].'">'.number_format($row_usd_grup['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['due_181_360'].'">'.number_format($row_usd_grup['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['due_gt_360'].'">'.number_format($row_usd_grup['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['total_due'].'">'.number_format($row_usd_grup['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_usd_grup['pro_due'].'">'.number_format($row_usd_grup['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['pro_due0'].'">'.number_format($row_usd_grup['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['pro_due1'].'">'.number_format($row_usd_grup['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['pro_due2'].'">'.number_format($row_usd_grup['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['pro_due3'].'">'.number_format($row_usd_grup['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['pro_due4'].'">'.number_format($row_usd_grup['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['pro_due5'].'">'.number_format($row_usd_grup['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_grup['tot_produe'].'">'.number_format($row_usd_grup['tot_produe'],2).'</th>                                                             
        </tr>
    ';
...
while($row_grup = mysqli_fetch_array($sql_grup)){

    echo '<tr style="font-size:12px;">
            <th colspan = "4" style="text-align: center;vertical-align: middle;">Summary Group</th> 
            <th style="text-align:right;" value="'.$row_grup['saldo_akhir_idr'].'">'.number_format($row_grup['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_grup['due_current'].'">'.number_format($row_grup['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['due_1_30'].'">'.number_format($row_grup['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['due_31_60'].'">'.number_format($row_grup['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['due_61_90'].'">'.number_format($row_grup['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['due_91_120'].'">'.number_format($row_grup['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['due_121_180'].'">'.number_format($row_grup['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['due_181_360'].'">'.number_format($row_grup['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['due_gt_360'].'">'.number_format($row_grup['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['total_due'].'">'.number_format($row_grup['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_grup['pro_due'].'">'.number_format($row_grup['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['pro_due0'].'">'.number_format($row_grup['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['pro_due1'].'">'.number_format($row_grup['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['pro_due2'].'">'.number_format($row_grup['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['pro_due3'].'">'.number_format($row_grup['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['pro_due4'].'">'.number_format($row_grup['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['pro_due5'].'">'.number_format($row_grup['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_grup['tot_produe'].'">'.number_format($row_grup['tot_produe'],2).'</th>                                                             
        </tr>
    ';
...
echo '
<tr>
    <th colspan="5" style="background:white;text-align:left;">NON GROUP</th>
    <th style="border:none;background:white;"></th>
    <th colspan="9" style="background:white;"></th>
    <th style="border:none;background:white;"></th>
    <th colspan="8" style="background:white;"></th>
...
$sql_non_grup = mysqli_query($conn2,$query2);
$no = 1;
while($row_non_grup = mysqli_fetch_array($sql_non_grup)){

    echo ' <tr style="font-size:12px;text-align:left;">
    <td style="text-align:center;">'.$no++.'</td>                          
    <td value="'.$row_non_grup['item_type2'].'">'.$row_non_grup['item_type2'].'</td>  
    <td value="'.$row_non_grup['curr'].'">'.$row_non_grup['curr'].'</td>                             
    <td style="text-align:right;" value = "'.number_format($row_non_grup['saldo_akhir'],2).'">'.number_format($row_non_grup['saldo_akhir'],2).'</td>
    <td style="text-align:right;" value = "'.number_format($row_non_grup['saldo_akhir_idr'],2).'">'.number_format($row_non_grup['saldo_akhir_idr'],2).'</td> 
    <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_current'].'">'.number_format($row_non_grup['due_current'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_1_30'].'">'.number_format($row_non_grup['due_1_30'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_31_60'].'">'.number_format($row_non_grup['due_31_60'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_61_90'].'">'.number_format($row_non_grup['due_61_90'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_91_120'].'">'.number_format($row_non_grup['due_91_120'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_121_180'].'">'.number_format($row_non_grup['due_121_180'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_181_360'].'">'.number_format($row_non_grup['due_181_360'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['due_gt_360'].'">'.number_format($row_non_grup['due_gt_360'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['total_due'].'">'.number_format($row_non_grup['total_due'],2).'</td>
    <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
    <td style="text-align:right;" value="'.$row_non_grup['pro_due'].'">'.number_format($row_non_grup['pro_due'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['pro_due0'].'">'.number_format($row_non_grup['pro_due0'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['pro_due1'].'">'.number_format($row_non_grup['pro_due1'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['pro_due2'].'">'.number_format($row_non_grup['pro_due2'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['pro_due3'].'">'.number_format($row_non_grup['pro_due3'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['pro_due4'].'">'.number_format($row_non_grup['pro_due4'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['pro_due5'].'">'.number_format($row_non_grup['pro_due5'],2).'</td>
    <td style="text-align:right;" value="'.$row_non_grup['tot_produe'].'">'.number_format($row_non_grup['tot_produe'],2).'</td>
    </tr>
    ';
...
$sql_idr_nongrup = mysqli_query($conn2,"
SELECT
    SUM(saldo_akhir) saldo_akhir,
    SUM(saldo_akhir_idr) saldo_akhir_idr,
    SUM(due_current) due_current,
...
while($row_idr = mysqli_fetch_array($sql_idr_nongrup)){
...
$sql_usd_nongrup = mysqli_query($conn2,"
SELECT
    SUM(saldo_akhir) saldo_akhir,
    SUM(saldo_akhir_idr) saldo_akhir_idr,
    SUM(due_current) due_current,
...
while($row_usd_nongrup = mysqli_fetch_array($sql_usd_nongrup)){

    echo '<tr style="font-size:12px;">
            <th colspan = "3" style="text-align: center;vertical-align: middle;">Total USD</th> 
            <th style="text-align:right;" value="'.$row_usd_nongrup['saldo_akhir'].'">'.number_format($row_usd_nongrup['saldo_akhir'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['saldo_akhir_idr'].'">'.number_format($row_usd_nongrup['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_current'].'">'.number_format($row_usd_nongrup['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_1_30'].'">'.number_format($row_usd_nongrup['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_31_60'].'">'.number_format($row_usd_nongrup['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_61_90'].'">'.number_format($row_usd_nongrup['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_91_120'].'">'.number_format($row_usd_nongrup['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_121_180'].'">'.number_format($row_usd_nongrup['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_181_360'].'">'.number_format($row_usd_nongrup['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['due_gt_360'].'">'.number_format($row_usd_nongrup['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['total_due'].'">'.number_format($row_usd_nongrup['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_usd_nongrup['pro_due'].'">'.number_format($row_usd_nongrup['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['pro_due0'].'">'.number_format($row_usd_nongrup['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['pro_due1'].'">'.number_format($row_usd_nongrup['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['pro_due2'].'">'.number_format($row_usd_nongrup['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['pro_due3'].'">'.number_format($row_usd_nongrup['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['pro_due4'].'">'.number_format($row_usd_nongrup['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['pro_due5'].'">'.number_format($row_usd_nongrup['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_nongrup['tot_produe'].'">'.number_format($row_usd_nongrup['tot_produe'],2).'</th>                                                             
        </tr>
    ';
...
$sql_nongrup = mysqli_query($conn2,"
SELECT
    SUM(saldo_akhir) saldo_akhir,
    SUM(saldo_akhir_idr) saldo_akhir_idr,
    SUM(due_current) due_current,
...
while($row_nongrup = mysqli_fetch_array($sql_nongrup)){

    echo '<tr style="font-size:12px;">
            <th colspan = "4" style="text-align: center;vertical-align: middle;">Summary Non Group</th> 
            <th style="text-align:right;" value="'.$row_nongrup['saldo_akhir_idr'].'">'.number_format($row_nongrup['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_nongrup['due_current'].'">'.number_format($row_nongrup['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['due_1_30'].'">'.number_format($row_nongrup['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['due_31_60'].'">'.number_format($row_nongrup['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['due_61_90'].'">'.number_format($row_nongrup['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['due_91_120'].'">'.number_format($row_nongrup['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['due_121_180'].'">'.number_format($row_nongrup['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['due_181_360'].'">'.number_format($row_nongrup['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['due_gt_360'].'">'.number_format($row_nongrup['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['total_due'].'">'.number_format($row_nongrup['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_nongrup['pro_due'].'">'.number_format($row_nongrup['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['pro_due0'].'">'.number_format($row_nongrup['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['pro_due1'].'">'.number_format($row_nongrup['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['pro_due2'].'">'.number_format($row_nongrup['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['pro_due3'].'">'.number_format($row_nongrup['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['pro_due4'].'">'.number_format($row_nongrup['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['pro_due5'].'">'.number_format($row_nongrup['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_nongrup['tot_produe'].'">'.number_format($row_nongrup['tot_produe'],2).'</th>                                                             
        </tr>
    ';
...
echo '
<tr>
    <th colspan="5" style="background:white;text-align:left;"></th>
    <th style="border:none;background:white;"></th>
    <th colspan="9" style="background:white;"></th>
    <th style="border:none;background:white;"></th>
    <th colspan="8" style="background:white;"></th>
...
$sql_idr_sum_all = mysqli_query($conn2,"
SELECT
    SUM(saldo_akhir) saldo_akhir,
    SUM(saldo_akhir_idr) saldo_akhir_idr,
    SUM(due_current) due_current,
...
while($row_idr_all = mysqli_fetch_array($sql_idr_sum_all)){

    echo '<tr style="font-size:12px;">
            <th colspan = "3" style="text-align: center;vertical-align: middle;">Summary Total IDR</th> 
            <th style="text-align:right;" value="'.$row_idr_all['saldo_akhir'].'">'.number_format($row_idr_all['saldo_akhir'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['saldo_akhir_idr'].'">'.number_format($row_idr_all['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_idr_all['due_current'].'">'.number_format($row_idr_all['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['due_1_30'].'">'.number_format($row_idr_all['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['due_31_60'].'">'.number_format($row_idr_all['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['due_61_90'].'">'.number_format($row_idr_all['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['due_91_120'].'">'.number_format($row_idr_all['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['due_121_180'].'">'.number_format($row_idr_all['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['due_181_360'].'">'.number_format($row_idr_all['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['due_gt_360'].'">'.number_format($row_idr_all['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['total_due'].'">'.number_format($row_idr_all['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_idr_all['pro_due'].'">'.number_format($row_idr_all['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['pro_due0'].'">'.number_format($row_idr_all['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['pro_due1'].'">'.number_format($row_idr_all['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['pro_due2'].'">'.number_format($row_idr_all['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['pro_due3'].'">'.number_format($row_idr_all['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['pro_due4'].'">'.number_format($row_idr_all['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['pro_due5'].'">'.number_format($row_idr_all['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_idr_all['tot_produe'].'">'.number_format($row_idr_all['tot_produe'],2).'</th>                                                             
        </tr>
    ';
...
$sql_usd_sum_all = mysqli_query($conn2,"
SELECT
    SUM(saldo_akhir) saldo_akhir,
    SUM(saldo_akhir_idr) saldo_akhir_idr,
    SUM(due_current) due_current,
...
while($row_usd_sum_all = mysqli_fetch_array($sql_usd_sum_all)){

    echo '<tr style="font-size:12px;">
            <th colspan = "3" style="text-align: center;vertical-align: middle;">Summary Total USD</th> 
            <th style="text-align:right;" value="'.$row_usd_sum_all['saldo_akhir'].'">'.number_format($row_usd_sum_all['saldo_akhir'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['saldo_akhir_idr'].'">'.number_format($row_usd_sum_all['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_current'].'">'.number_format($row_usd_sum_all['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_1_30'].'">'.number_format($row_usd_sum_all['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_31_60'].'">'.number_format($row_usd_sum_all['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_61_90'].'">'.number_format($row_usd_sum_all['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_91_120'].'">'.number_format($row_usd_sum_all['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_121_180'].'">'.number_format($row_usd_sum_all['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_181_360'].'">'.number_format($row_usd_sum_all['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['due_gt_360'].'">'.number_format($row_usd_sum_all['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['total_due'].'">'.number_format($row_usd_sum_all['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_usd_sum_all['pro_due'].'">'.number_format($row_usd_sum_all['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['pro_due0'].'">'.number_format($row_usd_sum_all['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['pro_due1'].'">'.number_format($row_usd_sum_all['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['pro_due2'].'">'.number_format($row_usd_sum_all['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['pro_due3'].'">'.number_format($row_usd_sum_all['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['pro_due4'].'">'.number_format($row_usd_sum_all['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['pro_due5'].'">'.number_format($row_usd_sum_all['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_usd_sum_all['tot_produe'].'">'.number_format($row_usd_sum_all['tot_produe'],2).'</th>                                                             
        </tr>
    ';
...
$sql_sum_all = mysqli_query($conn2,"
SELECT
    SUM(saldo_akhir) saldo_akhir,
    SUM(saldo_akhir_idr) saldo_akhir_idr,
    SUM(due_current) due_current,
...
while($row_sum_all = mysqli_fetch_array($sql_sum_all)){

    echo '<tr style="font-size:12px;">
            <th colspan = "4" style="text-align: center;vertical-align: middle;">Summary Total</th> 
            <th style="text-align:right;" value="'.$row_sum_all['saldo_akhir_idr'].'">'.number_format($row_sum_all['saldo_akhir_idr'],2).'</th>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_sum_all['due_current'].'">'.number_format($row_sum_all['due_current'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['due_1_30'].'">'.number_format($row_sum_all['due_1_30'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['due_31_60'].'">'.number_format($row_sum_all['due_31_60'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['due_61_90'].'">'.number_format($row_sum_all['due_61_90'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['due_91_120'].'">'.number_format($row_sum_all['due_91_120'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['due_121_180'].'">'.number_format($row_sum_all['due_121_180'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['due_181_360'].'">'.number_format($row_sum_all['due_181_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['due_gt_360'].'">'.number_format($row_sum_all['due_gt_360'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['total_due'].'">'.number_format($row_sum_all['total_due'],2).'</th>      
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <th style="text-align:right;" value="'.$row_sum_all['pro_due'].'">'.number_format($row_sum_all['pro_due'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['pro_due0'].'">'.number_format($row_sum_all['pro_due0'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['pro_due1'].'">'.number_format($row_sum_all['pro_due1'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['pro_due2'].'">'.number_format($row_sum_all['pro_due2'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['pro_due3'].'">'.number_format($row_sum_all['pro_due3'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['pro_due4'].'">'.number_format($row_sum_all['pro_due4'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['pro_due5'].'">'.number_format($row_sum_all['pro_due5'],2).'</th>
            <th style="text-align:right;" value="'.$row_sum_all['tot_produe'].'">'.number_format($row_sum_all['tot_produe'],2).'</th>                                                             
        </tr>
    ';
