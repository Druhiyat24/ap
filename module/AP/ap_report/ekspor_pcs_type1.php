...
<body>
    ...
    header("Content-Disposition: attachment; filename=AP Report - SUMMARY TYPE 1.xls");
    ...
    <h4> Payable Card Statement - SUMMARY TYPE 1<br/> PERIODE: <?php echo $start_date; ?> - <?php echo $end_date; ?></h4>
