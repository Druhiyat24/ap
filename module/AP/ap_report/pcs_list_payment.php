<div class="col-md-3 d-flex align-items-end">
    ...
    <a id="btnExportExcel_listpayment" target="_blank">
    ...
    <div class="card-body p-4">
      <div class="table-responsive">
          <table id="table-pcs-listpayment" 
          ...
          <thead class="table-gradient">
            ...
            <tr>
                ...
                <th id="proj-month-lp-1" style="background:#87CEFA;"></th>
                <th id="proj-month-lp-2" style="background:#87CEFA;"></th>
                <th id="proj-month-lp-3" style="background:#87CEFA;"></th>
                <th id="proj-month-lp-4" style="background:#87CEFA;"></th>
                <th id="proj-month-lp-5" style="background:#87CEFA;"></th>
                <th id="proj-month-lp-6" style="background:#87CEFA;"></th>
