      ...
      <div class="table-responsive">
          ...
          <thead class="table-gradient">
            <tr>
                ...
                <th rowspan="2" style="border: none;width: 50px;background-color: white;"></th> 
                <th colspan="8" id="thProjection-type2"  style="text-align: center;vertical-align: middle;background-color: #87CEFA;">Account Payable Based on Due Date Projection</th>
            </tr>
            <tr>
                ...
                <th id="proj-month-type2-1" style="background:#87CEFA;"></th>
                <th id="proj-month-type2-2" style="background:#87CEFA;"></th>
                <th id="proj-month-type2-3" style="background:#87CEFA;"></th>
                <th id="proj-month-type2-4" style="background:#87CEFA;"></th>
                <th id="proj-month-type2-5" style="background:#87CEFA;"></th>
                <th id="proj-month-type2-6" style="background:#87CEFA;"></th>
