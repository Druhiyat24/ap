...
$sql = mysqli_query($conn2, "SELECT * FROM ($sql_bpb) x $where ORDER BY supplier, tgl_bpb ASC");
// placeholder so the big old query block below is removed
if(false){$sql2 = mysqli_query($conn2, "WITH
...
CASE
    ...
    tot_produe * f AS tot_produe from laporan_mutasi $where"); } // old BPB query (disabled)
...
while($data = mysqli_fetch_assoc($sql)){
    ...
    $sheet->setCellValueByColumnAndRow($col++, $rowNum, Date::stringToExcel($data['tgl_bpb']));
    $sheet->setCellValueByColumnAndRow($col++, $rowNum, Date::stringToExcel($data['duedate']));
...
$sheet2->setTitle('AP-Payment Voucher');
...
$sql = mysqli_query($conn2, "SELECT * FROM ($sql_pv) x $where ORDER BY supplier, tgl_kbon ASC");
if(false){$sql_old2 = mysqli_query($conn2, "WITH
rate as (select * from ap_masterrate where tanggal = '$end_date' and v_codecurr = CASE  WHEN tanggal = LAST_DAY(tanggal) THEN 'HARIAN' ELSE 'PAJAK' END GROUP BY  curr, rate),
...
CASE WHEN duedate >= DATE_ADD(LAST_DAY('$end_date'), INTERVAL 5 MONTH)
THEN saldo_akhir_idr ELSE 0 END
) AS tot_produe from report_mutasi $where"); } // old kontrabon query (disabled)
...
while($data = mysqli_fetch_assoc($sql)){
    ...
    $sheet2->setCellValueByColumnAndRow($col++, $rowNum, Date::stringToExcel($data['tgl_kbon']));
    $sheet2->setCellValueByColumnAndRow($col++, $rowNum, Date::stringToExcel($data['duedate']));
...
if(false){ // AP-List Payment removed — not in current view
...
while($data = mysqli_fetch_assoc($sql)){
    ...
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, Date::stringToExcel($data['tgl_payment']));
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, Date::stringToExcel($data['duedate']));
...
} // end if(false) — AP-List Payment removed
...
$sheet3 = $spreadsheet->createSheet();
$sheet3->setTitle('AP-Sum Supp');


$sheet3->setCellValue('A1', 'Payable Card Statement - SUMMARY SUPPLIER');
$sheet3->setCellValue('A2', 'PERIODE: '.$start_date_text.' - '.$end_date_text);
$sheet3->mergeCells('A1:AG1');
$sheet3->mergeCells('A2:AG2');
$sheet3->getStyle('A1:A2')->getFont()->setBold(true)->setSize(12);
...
$headersFix = [
    ...
    'Deduction Advance','Deduction Other','Deduction Bank','Deduction Cash','Deduction Non Bank','Deduction GM',
...
";
$sql = mysqli_query($conn2, $sql_sum4);
if(false){$sql_old4 = mysqli_query($conn2, "WITH
bpb as (
WITH
rate as (select * from ap_masterrate where tanggal = '$end_date' and v_codecurr = CASE  WHEN tanggal = LAST_DAY(tanggal) THEN 'HARIAN' ELSE 'PAJAK' END GROUP BY  curr, rate),
...
while($data = mysqli_fetch_assoc($sql)){
    ...
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['curr']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['saldo_awal']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['addition']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['reverse']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['deduction_advance']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['deduction_other']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['ded_bank']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['ded_cash']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['ded_nonbank']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['deduction_gm']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['adjust']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['saldo_akhir']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['rate']);
    $sheet3->setCellValueByColumnAndRow($col++, $rowNum, $data['saldo_akhir_idr']);
    $col++; // spacer
...
$sheet3->getStyle('D6:'.$highestColumn.$rowNum)
      ->getNumberFormat()->setFormatCode('#,##0.00');
...
/*
|---------------------------------------------------------------------------------------------------------------------------------------------------------
| SHEET 4 AP-Sum Type 1
|---------------------------------------------------------------------------------------------------------------------------------------------------------
*/

$sheet4 = $spreadsheet->createSheet();
$sheet4->setTitle('AP-Sum Type 1');


$sheet4->setCellValue('A1', 'Payable Card Statement - SUMMARY TYPE 1');
$sheet4->setCellValue('A2', 'PERIODE: '.$start_date_text.' - '.$end_date_text);
$sheet4->mergeCells('A1:Y1');
$sheet4->mergeCells('A2:Y2');
...
$sql_type1 = "
SELECT supplier, item_type1, relasi,
    ROUND(SUM(saldo_akhir_idr),2) saldo_akhir,
    ROUND(SUM(saldo_akhir_idr) / SUM(SUM(saldo_akhir_idr)) OVER () * 100, 2) saldo_akhir_persen,
    ROUND(SUM(due_current),2) due_current,
    ROUND(SUM(due_1_30),2) due_1_30,
    ROUND(SUM(due_31_60),2) due_31_60,
    ROUND(SUM(due_61_90),2) due_61_90,
    ...
    ROUND(SUM(tot_produe),2) tot_produe
FROM (
    SELECT supplier, item_type1, relasi, saldo_akhir_idr, due_current, due_1_30, due_31_60, due_61_90, due_91_120, due_121_180, due_181_360, due_gt_360, total_due, pro_due, pro_due0, pro_due1, pro_due2, pro_due3, pro_due4, pro_due5, tot_produe FROM ($sql_bpb) bpb
    UNION ALL
    SELECT supplier, item_type1, relasi, saldo_akhir_idr, due_current, due_1_30, due_31_60, due_61_90, due_91_120, due_121_180, due_181_360, due_gt_360, total_due, pro_due, pro_due0, pro_due1, pro_due2, pro_due3, pro_due4, pro_due5, tot_produe FROM ($sql_pv) pv
) c $where GROUP BY supplier, item_type1, relasi ORDER BY supplier, item_type1 ASC
";
$sql = mysqli_query($conn2, $sql_type1);
if(false){$sql_old5 = mysqli_query($conn2, "WITH
bpb as (
WITH
rate as (select * from ap_masterrate where tanggal = '$end_date' and v_codecurr = CASE  WHEN tanggal = LAST_DAY(tanggal) THEN 'HARIAN' ELSE 'PAJAK' END GROUP BY  curr, rate),
...
$sheet4->getStyle('E6:'.$highestColumn.$rowNum)
      ->getNumberFormat()->setFormatCode('#,##0.00');
...
/*
|---------------------------------------------------------------------------------------------------------------------------------------------------------
| SHEET 5 AP-Sum Type 2
|---------------------------------------------------------------------------------------------------------------------------------------------------------
*/

$sheet5 = $spreadsheet->createSheet();
$sheet5->setTitle('AP-Sum Type 2');


$sheet5->setCellValue('A1', 'Payable Card Statement - SUMMARY TYPE 2');
...
SELECT supplier, item_type2, relasi,
    ...
    ROUND(SUM(tot_produe),2) tot_produe
FROM (
    SELECT supplier, item_type2, relasi, saldo_akhir_idr, due_current, due_1_30, due_31_60, due_61_90, due_91_120, due_121_180, due_181_360, due_gt_360, total_due, pro_due, pro_due0, pro_due1, pro_due2, pro_due3, pro_due4, pro_due5, tot_produe FROM ($sql_bpb) bpb
    UNION ALL
    SELECT supplier, item_type2, relasi, saldo_akhir_idr, due_current, due_1_30, due_31_60, due_61_90, due_91_120, due_121_180, due_181_360, due_gt_360, total_due, pro_due, pro_due0, pro_due1, pro_due2, pro_due3, pro_due4, pro_due5, tot_produe FROM ($sql_pv) pv
) c $where GROUP BY supplier, item_type2, relasi ORDER BY supplier, item_type2 ASC
";
$sql = mysqli_query($conn2, $sql_type2);
if(false){$sql_old6 = mysqli_query($conn2, "WITH
bpb as (
WITH
rate as (select * from ap_masterrate where tanggal = '$end_date' and v_codecurr = CASE  WHEN tanggal = LAST_DAY(tanggal) THEN 'HARIAN' ELSE 'PAJAK' END GROUP BY  curr, rate),
...
$sheet6->setTitle('AP-Summary');


$sheet6->setCellValue('A1', 'Payable Card Statement - SUMMARY');
$sheet6->setCellValue('A2', 'PERIODE: '.$start_date_text.' - '.$end_date_text);
$sheet6->mergeCells('A1:X1');
$sheet6->mergeCells('A2:X2');
...
$colIndex = 1;
$sheet6->setCellValueByColumnAndRow($colIndex, $rowHeader1, 'No');
$sheet6->mergeCellsByColumnAndRow($colIndex, $rowHeader1, $colIndex, $rowHeader2);
$colIndex++;

/* Supplier */
$sheet6->setCellValueByColumnAndRow($colIndex, $rowHeader1, 'Supplier Category & Name');
$sheet6->mergeCellsByColumnAndRow($colIndex, $rowHeader1, $colIndex, $rowHeader2);
$colIndex++;
...
$sheet6->setCellValueByColumnAndRow($amountStartCol, $rowHeader1, 'Amount');
$sheet6->mergeCellsByColumnAndRow(
    $amountStartCol,
    $rowHeader1,
    $amountStartCol + 2,
    $rowHeader1
...
foreach ($amountHeaders as $h) {
    $sheet6->setCellValueByColumnAndRow($colIndex, $rowHeader2, $h);
    $colIndex++;
}
...
$sheet6->mergeCells("A{$rowSection}:E{$rowSection}");
$sheet6->mergeCells("G{$rowSection}:O{$rowSection}");
$sheet6->mergeCells("Q{$rowSection}:X{$rowSection}");

/* Isi Text */
$sheet6->setCellValue("A{$rowSection}", "GROUP");
$sheet6->getStyle("A{$rowSection}")
...
$where7g = ($nama_supp != 'ALL') ? "WHERE supplier='$nama_supp' AND relasi='GROUP'" : "WHERE relasi='GROUP'";
...
SELECT supplier, curr,
    ...
    ROUND(SUM(due_current),2) due_current, ROUND(SUM(due_1_30),2) due_1_30,
    ROUND(SUM(due_31_60),2) due_31_60, ROUND(SUM(due_61_90),2) due_61_90,
    ROUND(SUM(due_91_120),2) due_91_120, ROUND(SUM(due_121_180),2) due_121_180,
    ROUND(SUM(due_181_360),2) due_181_360, ROUND(SUM(due_gt_360),2) due_gt_360,
    ROUND(SUM(total_due),2) total_due,
    ROUND(SUM(pro_due),2) pro_due, ROUND(SUM(pro_due0),2) pro_due0,
    ROUND(SUM(pro_due1),2) pro_due1, ROUND(SUM(pro_due2),2) pro_due2,
    ROUND(SUM(pro_due3),2) pro_due3, ROUND(SUM(pro_due4),2) pro_due4,
    ROUND(SUM(pro_due5),2) pro_due5, ROUND(SUM(tot_produe),2) tot_produe
FROM ($sql_combined7) a
$where7g
GROUP BY supplier, curr ORDER BY supplier, curr ASC
");

if(false){$sql_old7g = mysqli_query($conn2, "WITH
bpb as (
WITH
rate as (select * from ap_masterrate where tanggal = '$end_date' and v_codecurr = CASE  WHEN tanggal = LAST_DAY(tanggal) THEN 'HARIAN' ELSE 'PAJAK' END GROUP BY  curr, rate),
...
if ($dataEndRow >= $dataStartRow) {
    ...
    // Saldo
    $sheet6->setCellValue("D{$totalIDRRow}",
        "=SUMIF(C{$dataStartRow}:C{$dataEndRow},\"IDR\",D{$dataStartRow}:D{$dataEndRow})");

    $sheet6->setCellValue("E{$totalIDRRow}",
    ...
    $sheet6->setCellValue("D{$totalUSDRow}",
        "=SUMIF(C{$dataStartRow}:C{$dataEndRow},\"USD\",D{$dataStartRow}:D{$dataEndRow})");

    $sheet6->setCellValue("E{$totalUSDRow}",
    ...
    $sheet6->setCellValue("E{$summaryRow_GROUP}",
...
$sheet6->setCellValue("A{$rowSection}", "NON GROUP");
$sheet6->getStyle("A{$rowSection}")->getFont()->setBold(true);

$rowNum = $rowSection + 1;

$no = 1;

$where7ng = ($nama_supp != 'ALL') ? "WHERE supplier='$nama_supp' AND relasi='NON GROUP'" : "WHERE relasi='NON GROUP'";
$sql = mysqli_query($conn2, "
SELECT item_type2, curr,
    ROUND(SUM(IF(UPPER(curr)!='IDR',saldo_akhir,0)),2) saldo_akhir,
    ROUND(SUM(saldo_akhir_idr),2) saldo_akhir_idr,
    ROUND(SUM(due_current),2) due_current, ROUND(SUM(due_1_30),2) due_1_30,
    ROUND(SUM(due_31_60),2) due_31_60, ROUND(SUM(due_61_90),2) due_61_90,
...
FROM ($sql_combined7) a
$where7ng
GROUP BY item_type2, curr ORDER BY item_type2, curr ASC
");

if(false){$sql_old7ng = mysqli_query($conn2, "WITH
bpb as (
WITH
rate as (select * from ap_masterrate where tanggal = '$end_date' and v_codecurr = CASE  WHEN tanggal = LAST_DAY(tanggal) THEN 'HARIAN' ELSE 'PAJAK' END GROUP BY  curr, rate),
...
if ($dataEndRow >= $dataStartRow) {
    ...
    /* BORDER DATA */
    $sheet6->getStyle("A{$dataStartRow}:{$lastColLetter}{$dataEndRow}")
        ->getBorders()
        ->getAllBorders()
        ->setBorderStyle(Border::BORDER_THIN);
    ...
    $sheet6->getStyle("A{$totalIDRRow_NON}:{$lastColLetter}{$totalIDRRow_NON}")
        ->applyFromArray([
            'font' => ['bold' => true],
            'borders' => [
    ...
    $sheet6->setCellValue("D{$totalIDRRow_NON}",
        "=SUMIF(C{$dataStartRow}:C{$dataEndRow},\"IDR\",D{$dataStartRow}:D{$dataEndRow})");

    $sheet6->setCellValue("E{$totalIDRRow_NON}",
        "=SUMIF(C{$dataStartRow}:C{$dataEndRow},\"IDR\",E{$dataStartRow}:E{$dataEndRow})");
    ...
    $sheet6->getStyle("A{$totalUSDRow_NON}:{$lastColLetter}{$totalUSDRow_NON}")
        ->applyFromArray([
            'font' => ['bold' => true],
            'borders' => [
                'allBorders' => ['borderStyle' => Border::BORDER_THIN],
    ...
    $sheet6->setCellValue("D{$totalUSDRow_NON}",
        "=SUMIF(C{$dataStartRow}:C{$dataEndRow},\"USD\",D{$dataStartRow}:D{$dataEndRow})");

    $sheet6->setCellValue("E{$totalUSDRow_NON}",
        "=SUMIF(C{$dataStartRow}:C{$dataEndRow},\"USD\",E{$dataStartRow}:E{$dataEndRow})");
    ...
    $sheet6->setCellValue("E{$summaryRow}",
        "=SUM(E{$dataStartRow}:E{$dataEndRow})");
...
$sheet6->mergeCells("A{$grandTotalIDRRow}:C{$grandTotalIDRRow}");
$sheet6->setCellValue("A{$grandTotalIDRRow}", "Grand Total IDR");

$sheet6->getStyle("A{$grandTotalIDRRow}:{$lastColLetter}{$grandTotalIDRRow}")
    ->applyFromArray([
        'font' => ['bold' => true],
        'fill' => [
            'fillType' => Fill::FILL_SOLID,
    ...
    $sheet6->getStyle("A{$grandTotalIDRRow}")
    ->applyFromArray([
        'font' => ['bold' => true],
        'alignment' => [
            'horizontal' => Alignment::HORIZONTAL_CENTER,
...
$sheet6->mergeCells("A{$grandTotalUSDRow}:C{$grandTotalUSDRow}");
$sheet6->setCellValue("A{$grandTotalUSDRow}", "Grand Total USD");

$sheet6->getStyle("A{$grandTotalUSDRow}:{$lastColLetter}{$grandTotalUSDRow}")
    ->applyFromArray([
        'font' => ['bold' => true],
        'fill' => [
            'fillType' => Fill::FILL_SOLID,
    ...
    $sheet6->getStyle("A{$grandTotalUSDRow}")
    ->applyFromArray([
        'font' => ['bold' => true],
        'alignment' => [
            'horizontal' => Alignment::HORIZONTAL_CENTER,
...
$sheet6->mergeCells("A{$grandSummaryRow}:D{$grandSummaryRow}");
$sheet6->setCellValue("A{$grandSummaryRow}", "Grand Summary");

$sheet6->getStyle("A{$grandSummaryRow}:{$lastColLetter}{$grandSummaryRow}")
    ->applyFromArray([
        'font' => ['bold' => true],
        'fill' => [
            'fillType' => Fill::FILL_SOLID,
    ...
    $sheet6->getStyle("A{$grandSummaryRow}")
    ->applyFromArray([
        'font' => ['bold' => true],
        'alignment' => [
            'horizontal' => Alignment::HORIZONTAL_CENTER,
...
$sheet6->getStyle('D6:'.$highestColumn.$rowNum)
      ->getNumberFormat()->setFormatCode('#,##0.00');
