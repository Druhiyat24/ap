...
SELECT supplier,
    ...
    ROUND(SUM(tot_produe),2) tot_produe FROM (select supplier, item_type2, relasi, saldo_akhir_idr saldo_akhir, due_current, due_1_30, due_31_60, due_61_90, due_gt_360, due_91_120, due_121_180, due_181_360, total_due, pro_due2, pro_due, pro_due0, pro_due1, pro_due3, pro_due4, pro_due5, tot_produe from ($sql_bpb) bpb
        UNION ALL
...
?>
<html>
<head><title>AP Report - SUMMARY TYPE 2</title></head>
<body>
<style>
...
<h4>Payable Card Statement - SUMMARY TYPE 2<br>PERIODE: <?= $label_start ?> - <?= $label_end ?></h4>
...
<tr>
    ...
    <th rowspan="2" class="h-default">Item Type</th>
    <th rowspan="2" class="h-default">Relationship</th>
    <th rowspan="2" class="h-default">Amount (Equivalent IDR)</th>
    <th rowspan="2" class="h-default">Percentage from Total</th>
...
<tr style="font-size:10px;">
    ...
    <td class="num"><?= $nf($row['saldo_akhir_persen']) ?></td>
