...
$sql3 = "update bpb set confirm = 'N', confirm_by = '', confirm_date = '', status_maintain = null where bpbno_int = '$no_dok'";
$execute3 = mysqli_query($conn2,$sql3);

$sql4 = "update bppb set confirm = 'N', confirm_by = '', confirm_date = '', status_maintain = null where bppbno_int = '$no_dok'";
$execute4 = mysqli_query($conn2,$sql4);

$sql5 = "update whs_inmaterial_fabric set status = 'Pending', approved_by = '', approved_date = '' where no_dok = '$no_dok'";
$execute5 = mysqli_query($conn2,$sql5);

$sql6 = "update whs_bppb_h set status = 'Pending', approved_by = '', approved_date = '' where no_bppb = '$no_dok'";
