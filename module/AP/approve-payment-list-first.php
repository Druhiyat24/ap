...
<div class="container-fluid mt-4 p-4">
    ...
    <div class="card shadow border-0">
        ...
        <h5 class="mb-0"><i class="fa fa-thumbs-up" aria-hidden="true"></i> FIRST APPROVAL - PAYMENT LIST</h5>
    </div>
    </div>
...
<script type="text/javascript">
    ...
    // Bulk First Approve - semua PL terpilih dikirim ke first_approve_payment_list.php
    $('#btnApproveSelected').on('click', function () {
        ...
        Swal.fire({
            ...
            const requests = plNumbers.map(pl_number => $.ajax({
                type: 'POST',
                url: 'first_approve_payment_list.php',
                data: { pl_number: pl_number }
            }));
