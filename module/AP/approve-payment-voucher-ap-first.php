...
<div class="container-fluid mt-4 p-4">
    ...
    <div class="card shadow border-0">
        ...
        <h5 class="mb-0"><i class="fa fa-thumbs-up" aria-hidden="true"></i> FIRST APPROVAL - PAYMENT VOUCHER</h5>
    </div>
...
<div class="card shadow border-0 mt-4">
    <div class="card-body p-4">
        ...
        <div class="pv-approve-bar">
            <button type="button" class="btn btn-info btn-pv-approve" id="btnApproveSelected" disabled>
...
<script type="text/javascript">
    ...
    // Bulk First Approve - tiap baris dikirim ke endpoint sesuai data-type-nya
    $('#btnApproveSelected').on('click', function () {
        ...
        Swal.fire({
            ...
            const requests = items.map(item => $.ajax({
                type: 'POST',
                url: APPROVE_ENDPOINT[item.type] || 'first_approve_kbon.php',
