...
if(isset($no_dok)){
$sql = "update ir_invoice_supp_h set status = 'Accepted Pch', updated_at = '$confirm_date', receive_pch_by = '$approve_user', receive_pch_date = '$confirm_date' where doc_number = '$no_kbon'";
