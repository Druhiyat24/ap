...
if(isset($no_kbon)){
$sql = "update ir_invoice_supp_h set status = 'Accepted Acc', updated_at = '$confirm_date', receive_acc_by = '$approve_user', receive_acc_date = '$confirm_date' where doc_number = '$no_kbon'";
