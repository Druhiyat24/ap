...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fa fa-sign-in" aria-hidden="true"></i> FABRIC SUMMARY BARCODE</h5>
</div>

<div class="card-body p-3">
  <form id="form-data" action="ca_fabric_summary_barcode.php" method="post">
    <div class="row g-3">
   ...
   <div class="col-md-3 d-flex align-items-end">
    ...
    // echo '<a style="padding-right: 10px;" target="_blank" href="ekspor_ca_fabric_summary_barcode.php?start_date='.$start_date.' && end_date='.$end_date.'"><button type="button" class="btn btn-success ml-2" style= "margin-top: 30px;"><i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;font-size: 1rem;color: #fff;text-shadow: 1px 1px 1px #000"> Excel</i></button></a>';
...
<script type="text/javascript">
    document.getElementById('btncreate').onclick = function () {
        location.href = "ca_fabric_summary_barcode.php";
    };
</script>
