...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fa fa-sign-in" aria-hidden="true"></i> FABRIC SUMMARY ITEM</h5>
</div>

<div class="card-body p-3">
  <form id="form-data" action="ca_fabric_summary_item.php" method="post">
    <div class="row g-3">
...
<script>
    ...
    return `${p[2]}-${p[1]}-${p[0]}`;
         ...
         let datatable = $("#mytable").DataTable({
            ...
            scrollX: false,
        ajax: {
            url: 'http://10.10.5.62:8000/nds_wip/public/index.php/api/mutasi-item-fabric/mutasi-material/mutasi-item-fabric',
            dataType: 'json',
            dataSrc: 'data',
            method: 'POST',
            data: function(d) {
    ...
    // --- Saldo Awal ---
    { data: 'saldo_awal_qty' },
    { data: 'saldo_awal_price' },   // dipindah ke atas
    { data: 'saldo_awal_total' },
    ...
    // --- In Subcont ---
    { data: 'in_subcont_qty' },
    { data: 'in_subcont_price' },
    { data: 'in_subcont_total' },

    // --- In Produksi ---
    { data: 'in_produksi_qty' },
    { data: 'in_produksi_price' },
    { data: 'in_produksi_total' },

    // --- In Sample ---
    { data: 'in_sample_qty' },
    { data: 'in_sample_price' },
    { data: 'in_sample_total' },

    // --- Jumlah In ---
    { data: 'jumlah_in_qty' },
    { data: 'jumlah_in_price' },
    { data: 'jumlah_in_total' },
    ...
    // --- Out Subcont ---
    { data: 'out_subcont_qty' },
    { data: 'out_subcont_price' },
    { data: 'out_subcont_total' },

    // --- Out Lokal ---
    { data: 'out_lokal_qty' },
    { data: 'out_lokal_price' },
    { data: 'out_lokal_total' },

    // --- Out Impor ---
    { data: 'out_impor_qty' },
    { data: 'out_impor_price' },
    { data: 'out_impor_total' },

    // --- Out Sample ---
    { data: 'out_sample_qty' },
    { data: 'out_sample_price' },
    { data: 'out_sample_total' },

    // --- Out Sal Non Group ---
    { data: 'out_salnongroup_qty' },
    { data: 'out_salnongroup_price' },
    { data: 'out_salnongroup_total' },

    // --- Out Sal Group ---
    { data: 'out_salgroup_qty' },
    { data: 'out_salgroup_price' },
    { data: 'out_salgroup_total' },

    // --- Out Other ---
    { data: 'out_other_qty' },
    { data: 'out_other_price' },
    { data: 'out_other_total' },
    ...
    { data: 'saldo_akhir_total' }
],

        columnDefs: [
        {
            targets: [...Array(56).keys()].slice(6),
...
<script type="text/javascript">
    document.getElementById('btncreate').onclick = function () {
        location.href = "ca_fabric_summary_item.php";
    };
</script>
