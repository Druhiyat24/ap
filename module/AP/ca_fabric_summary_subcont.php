...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fa fa-sign-in" aria-hidden="true"></i> FABRIC SUMMARY SUBCONTRACTOR</h5>
</div>

<div class="card-body p-3">
  <form id="form-data" action="ca_fabric_summary_subcont.php" method="post">
    <div class="row g-3">
   ...
   <div class="col-md-3 d-flex align-items-end">
    ...
    // echo '<a style="padding-right: 10px;" target="_blank" href="ekspor_ca_fabric_summary_subcont.php?start_date='.$start_date.' && end_date='.$end_date.'"><button type="button" class="btn btn-success ml-2" style= "margin-top: 30px;"><i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;font-size: 1rem;color: #fff;text-shadow: 1px 1px 1px #000"> Excel</i></button></a>';
...
<script>
    ...
    return `${p[2]}-${p[1]}-${p[0]}`;
         ...
         let datatable = $("#mytable").DataTable({
            ...
            scrollX: false,
        ajax: {
            url: 'http://10.10.5.62:8000/nds_wip/public/index.php/api/mutasi-fabric-subcont/mutasi-material/mutasi-fabric-subcont',
            dataType: 'json',
            dataSrc: 'data',
            method: 'POST',
            data: function(d) {
...
document.getElementById('btnExportExcel').addEventListener('click', function(e) {
    ...
    // set dynamic href
    this.href = `ekspor_ca_fabric_summary_subcont.php?start_date=${sd}&end_date=${ed}`;
});
...
<script type="text/javascript">
    document.getElementById('btncreate').onclick = function () {
        location.href = "ca_fabric_summary_subcont.php";
    };
</script>
