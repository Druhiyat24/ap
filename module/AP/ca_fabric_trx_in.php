        ...
        <div class="col-md-12">      
         <div class="tableFix" style="height: 450px;">        
            ...
            while($row2 = mysqli_fetch_array($sql)){
                ...
                . number_format(($row2['price_non_subkon'] == 0 ? $row2['nilai_barang'] : $row2['price_non_subkon']), 2)
                . '</td>
            ...
            <th style="text-align : right;" value = "'.$total_nonsub.'">'.number_format($total_nonsub + $total_nilaibrg,2).'</th>
            ...
            <th style="text-align : right;" value = "'.$total_nonsub_idr.'">'.number_format($total_nonsub_idr + $total_nilaibrg_idr,2).'</th>
