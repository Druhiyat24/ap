...
if(isset($no_dok)){
$sql = "update ir_invoice_supp_h set status = 'Received', updated_at = '$confirm_date', cancel_acc_by = '$approve_user', cancel_acc_date = '$confirm_date',tfta_by = null, tfta_date = null where doc_number = '$no_kbon'";
