...
<table id="table-memo" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%" style="font-size: 12px;text-align:center;">
                    <thead>
                        <tr>
            ...
            $table .= '<tr>
                        <td style="width:10px;"><input type="checkbox" name="select[]" value=""></td>
