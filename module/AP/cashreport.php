       ...
       <form id="form-data" action="cashreport.php" method="post">        
        <div class="form-row">
            ...
            <label for="accountid" class="col-form-label" ><b>Account </b></label>  
                ...
                <?php 
                        $sqlacc = mysqli_query($conn1,"select no_coa as account, 'IDR' as curr,concat(no_coa,' ', nama_coa) as coa, SUBSTR(nama_coa,11,1) as kode from mastercoa_v2 where no_coa like '%1.01%'");
