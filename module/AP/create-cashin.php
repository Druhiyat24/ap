...
function initializePlugins() {
   ...
   function addRow(tableID) {
    ...
    <td><select class="form-control selectpicker nomor_cc" name="nomor_cc[]" id="nomor_cc" data-live-search="true" data-width="200px" data-size="5"><option value="-"> - </option></select></td>
    ...
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        if (total >= '1' && type_co != '') {
            $.ajax({
                ...
                data: {'doc_num':doc_num, 'doc_date':doc_date, 'from_ip':from_ip, 'create_user':create_user, 'pesan':pesan, 'total':total, 'type_co':type_co, 'total_nak':total_nak, 'total_nag':total_nag},
                cache: 'false',
                close: function(e){
                    e.preventDefault();
                },
