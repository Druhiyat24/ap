        ...
        <div class="box header">
            <form id="form-data" method="post">
                <div class="form-row">
                  ...
                  echo'<input type="hidden" readonly style="font-size: 14px;" class="form-control-plaintext" id="no_doc_sb1" name="no_doc_sb1" value="'.$kodepay.'">'
                  ?>
              </div>

              <div class="col-md-2 mb-3">            
                <label for="total" class="col-form-label" style="width: 150px;"><b>Date</b></label>
                <input type="text" style="font-size: 15px;" name="tgl_doc" id="tgl_doc" class="form-control tanggal" onchange="getrate();this.form.submit();" 
                value="<?php 
...
<input type="number" min="1" style="font-size: 12px;width: 150px;" class="form-control" id="txt_amount" name="txt_amount" oninput="modal_input_amt(value)" autocomplete="off">
</td>
<td>
<input type="number" min="1" style="font-size: 12px;width: 150px;" class="form-control" id="txt_amount" name="txt_amount" oninput="modal_input_amt2(value)" autocomplete="off">
</td>
<td>
<input type="text" class="form-control" style="font-size: 12px;width: 150px;" name="keterangan[]" placeholder="" autocomplete="off">
</td>
...
<script type="text/javascript">
  function ubahrate(curr){ 
    ...
    for (var i = 0; i < (table.rows.length); i++) {
        ...
        document.getElementById("tbody2").rows[i].cells[9].children[0].value = rate.toFixed(2);
        document.getElementsByName("txt_debit")[0].value = formatMoney(total.toFixed(2));
        document.getElementsByName("txt_debit_h")[0].value = total.toFixed(2);
        document.getElementsByName("txt_debit_idr")[0].value = formatMoney(total_h.toFixed(2));
        document.getElementsByName("txt_debit_idr_h")[0].value = total_h.toFixed(2);
...
<script type="text/javascript">
    ...
    for (var i = 0; i < (table.rows.length); i++) {
        ...
        var rate = document.getElementById("tbody2").rows[i].cells[9].children[0].value || 1;
