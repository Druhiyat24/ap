 ...
 <div class="form-row">
    ...
    <tbody id="tbody2">
        <tr style="display: none;">
            ...
            <td >
                <select class="form-control" name="nomor_cc" id="nomor_cc" > <option value="-" > - </option> <?php $sql2 = mysqli_query($conn1,"select no_cc as code_combine,cc_name, CONCAT(no_cc,' ',cc_name) as cost_name from b_master_cc where status = 'Active'"); foreach ($sql2 as $ncc) : echo'<option value="'.$ncc["code_combine"].'"> '.$ncc["cost_name"].' </option>'; endforeach; ?>
                </select>
            </td>
            <td>
