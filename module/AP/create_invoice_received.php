<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h3 class="text-center">CREATE INVOICE RECEIVED</h3>
<div class="box">
...
<form id="form-data" method="post">
    <div class="form-row md-6">
        ...
        <div class="col-md-2 mb-3">            
            <label for="total" class="col-form-label" style="width: 150px;"><b>Received Date</b></label>
            <input type="text" style="font-size: 12px;" name="tgl_doc" id="tgl_doc" class="form-control tanggal" 
            value="<?php 
        ...
        <div class="col-md-3 mb-3" style="padding-top: 8px;">
            <label for="no_reff"><b>No Reff</b></label>                                                         
            <input type="text" style="font-size: 12px;" class="form-control" id="no_reff" name="no_reff" value="">
        </div>
        <div class="col-md-5 mb-3" style="padding-top: 8px;">
        </div>
    ...
    <div class="form-row md-6">
        <div class="col-md-7" >
            ...
            <textarea style="font-size: 14px; text-align: left;" cols="40" rows="3" type="text" class="form-control " name="pesan" id="pesan" value="" placeholder="descriptions..." required></textarea>         
        </div>
    </div>
</br>
 ...
 <div class="form-row">
    ...
    <div class="box body">
        ...
        <tr class="bg-dark text-white">
            ...
            <th class="text-center" style="width: 16%">No Invoice</th>
