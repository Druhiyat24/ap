            ...
            <form id="form-data" method="post">
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">  
                        ...
                        <select class="form-control selectpicker" name="no_coa" id="no_coa" data-dropup-auto="false" data-live-search="true" onchange="updateCostCenter()">
                            <option value="" disabled selected="true">Pilih Item</option> 
                            <?php
                            $no_coa ='';
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="h_profit_center" class="col-form-label"><b>Profit Center</b></label>            
                        <select class="form-control selectpicker" name="h_profit_center" id="h_profit_center" data-dropup-auto="false" data-live-search="true" onchange="updateCostCenter()">
            ...
            <div class="table-responsive">
                <table id="mytable" class="table table-striped table-bordered text-nowrap" cellspacing="0" width="100%" style="font-size: 12px;text-align:center;">
                    ...
                    <tbody id="data_mapping">
                        ...
                        $sql = mysqli_query($conn2,"select a.id,jns_trans,ditagihkan,id_ctg,nm_ctg,id_sub_ctg,nm_sub_ctg,id_item,item_name,no_coa,nama_coa,id_cc,cc_name,nama_pc from memo_mapping_v2 a inner join master_pc b on b.kode_pc = a.profit_center where id_sub_ctg = '$id_sub'");
...
<script type="text/javascript">
    ...
    var noCoa = document.getElementById('no_coa').value;
    var profCtr = document.getElementById('h_profit_center').value; 
    const costCtrDropdown = $('#no_cc'); // gunakan ID, bukan class

    // Kosongkan dropdown cost center sebelum diisi
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response && response.length > 0) {
                    ...
                    console.warn('No cost center data from server.');
                }
...
<script type="text/javascript">
    $("#form-data").on("click", "#simpan", function(){
        ...
        var h_profit_center = document.getElementById('h_profit_center').value;       
        ...
        if (jns_trans != '' && ditagihkan != '' && no_coa != '') {
            $.ajax({
                ...
                data: {'id_ctg':id_ctg, 'nm_ctg':nm_ctg, 'id_sub_ctg':id_sub_ctg, 'nm_sub_ctg':nm_sub_ctg,'jns_trans':jns_trans, 'ditagihkan':ditagihkan, 'id_item':id_item, 'no_coa':no_coa, 'no_cc':no_cc, 'h_profit_center': h_profit_center},
                cache: 'false',
                close: function(e){
                    e.preventDefault();
                },
