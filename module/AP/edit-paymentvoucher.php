            ...
            <table id="mytable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 12px;text-align:center;">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 100px;">COA</th>
                        <th class="text-center" style="width: 100px;">Profit Center</th>
                        <th class="text-center" style="width: 100px;">Cost Center</th>
                        <th class="text-center" style="width: 100px;">Reff Doc</th>
                        <th class="text-center" style="width: 100px;">Reff Date</th>
                        ...
                        <th class="text-center" style="width: 100px;">PPH</th>
...
while($row = mysql_fetch_array($sqlpv)){
    ...
    <td><input type="checkbox" id="select" name="select[]" value="" checked disabled></td>
    <td >
    <select class="form-control selectpicker" name="nomor_coa" id="nomor_coa" data-live-search="true" data-width="150px" data-size="5"> <option value="'.$row['coa'].'" >'.$row['nama_coa'].'</option><option value="-" > - </option>';  $sql = mysqli_query($conn1,"select no_coa as id_coa,concat(no_coa,' ', nama_coa) as coa from mastercoa_v2 where no_coa != '$coa'"); foreach ($sql as $cc) : echo'<option value="'.$cc["id_coa"].'"> '.$cc["coa"].' </option>'; endforeach; ?>
    <?php
    echo '
    </select>
    </td>
    <td >
    <select class="form-control selectpicker prof_ctr" name="prof_ctr" id="prof_ctr" data-live-search="true" data-width="150px" data-size="5"> <option value="'.$row['kode_pc'].'" >'.$row['nama_pc'].'</option>';  $sql2 = mysqli_query($conn1,"select kode_pc, id_pc,nama_pc, CONCAT(id_pc,' - ',nama_pc) tampil from master_pc where status = 'Active' and kode_pc != '$kode_pc'"); foreach ($sql2 as $ccs) : echo'<option value="'.$ccs["kode_pc"].'"> '.$ccs["tampil"].' </option>'; endforeach; echo'<option value="-" > - </option>' ?>
    <?php
    echo '
    </select>
    </td>
    <td >
    <select class="form-control selectpicker nomor_cc" name="nomor_cc" id="nomor_cc" data-live-search="true" data-width="150px" data-size="5"> <option value="'.$row['no_cc'].'" >'.$row['cc_name'].'</option><option value="-" > - </option>';  $sql2 = mysqli_query($conn1,"select no_cc as code_combine,concat(no_cc,' - ',cc_name) as cost_name from b_master_cc where status = 'Active' and no_cc != '$no_cc'"); foreach ($sql2 as $ccs) : echo'<option value="'.$ccs["code_combine"].'"> '.$ccs["cost_name"].' </option>'; endforeach; ?>
    <?php
    echo '
    </select>
    </td>
    <td>
    <input type="text" class="form-control" name="keterangan[]" placeholder="" value="'.$row['reff_doc'].'" style="font-size: 12px;width: 150px;" autocomplete="off">
    </td>
    <td>
    <input type="text" style="font-size: 12px;width: 150px;" name="tgl_active" id="tgl_active" value="'.$reffdate.'" class="form-control tanggal" 
    value="" autocomplete="off" placeholder="dd-mm-yyyy">
    </td>
    <td>
    <input type="text" class="form-control" name="keterangan[]" value="'.$row['deskripsi'].'" placeholder="" style="font-size: 12px;width: 150px;" autocomplete="off"> 
    </td>';
    if ($amount == '0') {
        echo '<td>
        <input style="text-align: right;font-size: 12px;width: 150px;" type="number" min="1" value="" style="font-size: 12px;width: 150px;" class="form-control" id="txt_amount" name="txt_amount"  oninput="modal_input_amt(value)" autocomplete = "off" readonly>
        </td>';
    }else{
        echo '<td>
        <input style="text-align: right;font-size: 12px;width: 150px;" type="number" min="1" value="'.$row['amount'].'" style="font-size: 12px;width: 150px;" class="form-control" id="txt_amount" name="txt_amount"  oninput="modal_input_amt(value)" autocomplete = "off">
        </td>';
    }

    if ($ded_add == '0') {
        echo '<td>
        <input style="text-align: right;font-size: 12px;width: 150px;" type="number" min="1" value="" style="font-size: 12px;width: 150px;" class="form-control" id="txt_amount" name="txt_amount"  oninput="modal_input_dedadd(value)" autocomplete = "off" readonly>
        </td>';
    }else{
        echo '<td>
        <input style="text-align: right;font-size: 12px;width: 150px;" type="number" min="1" value="'.$row['ded_add'].'" style="font-size: 12px;width: 150px;" class="form-control" id="txt_amount" name="txt_amount"  oninput="modal_input_dedadd(value)" autocomplete = "off">
        </td>';
    }
    echo '
    <td>
    <input type="text" style="font-size: 12px;width: 150px;" name="tgl_tempo" id="tgl_tempo" value="'.$due_date.'" class="form-control tanggal" 
    autocomplete="off" placeholder="dd-mm-yyyy" >
    </td>
    <td >
    <select class="form-control selectpicker" name="pphh" id="pphh"  onchange="input_pph()" data-live-search="true" data-width="150px" data-size="5"> <option data-idtax="'.$row['id_pph'].'" value="'.$row['pph'].'" >'.$row['kriteria'].'</option><option value="0" > Non PPH </option>'; $sql = mysqli_query($conn1,"select idtax, kriteria, percentage, GROUP_CONCAT(kriteria,' (',percentage,'%)') as kriteria2 from mtax where category_tax = 'PPH' and idtax != '$id_pph' GROUP BY idtax"); foreach ($sql as $cc) : echo'<option data-idtax="'.$cc['idtax'].'" value="'.$cc["percentage"].'"> '.$cc["kriteria2"].' </option>'; endforeach; ?>
    <?php echo'</select>
    </td>

    <td >
    <select class="form-control selectpicker" name="ppnn" id="ppnn"  onchange="input_ppn()" data-live-search="true" data-width="150px" data-size="5"> <option data-idtax="'.$row['id_ppn'].'" value="'.$row['ppn'].'" >'.$row['kriteria2'].'</option><option value="" > Non PPN </option>'; $sql = mysqli_query($conn1,"select idtax, kriteria, percentage, GROUP_CONCAT(kriteria,' (',percentage,'%)') as kriteria2 from mtax where category_tax = 'PPN' and idtax != '$id_ppn' GROUP BY idtax"); foreach ($sql as $cc) : echo'<option data-idtax="'.$cc['idtax'].'" value="'.$cc["percentage"].'"> '.$cc["kriteria2"].' </option>'; endforeach; ?>
    <?php echo'</select>
    </td>
...
<tr>
    ...
    <td>
        <select class="form-control selectpicker prof_ctr" name="prof_ctr" id="prof_ctr" data-live-search="true" data-width="150px" data-size="5">
            <option value="-"> - </option>
            <?php
    ...
    <td>
        <select class="form-control selectpicker nomor_cc" name="nomor_cc[]" id="nomor_cc" data-live-search="true" data-width="150px" data-size="5">
            <option value="-"> - </option>
        </select>
    </td>

    <td>
        <input style="font-size: 12px;" type="text" class="form-control" name="keterangan[]" placeholder="" autocomplete="off">
    </td>

    <td>
        <input type="text" style="font-size: 12px;" name="tgl_active" id="tgl_active" class="form-control tanggal" value="" autocomplete="off" placeholder="dd-mm-yyyy">
    </td>
    ...
    <td>
        <input style="text-align: right; font-size: 12px;" type="number" min="1" class="form-control" id="txt_amount" name="txt_amount" oninput="modal_input_amt(value)" autocomplete="off">
    </td>

    <td>
        <input style="text-align: right; font-size: 12px;" type="number" min="1" class="form-control" id="txt_credit" name="txt_credit" oninput="modal_input_dedadd(value)" autocomplete="off">
    </td>

    <td>
        <input type="text" style="font-size: 12px;" name="tgl_tempo" id="tgl_tempo" class="form-control tanggal" autocomplete="off" placeholder="dd-mm-yyyy" value="<?= date('d-m-Y'); ?>">
    </td>

    <td style="width: 50px">
        <select class="form-control select2add" name="pphh" data-live-search="true" onchange="input_pph()" data-width="150px" data-size="5">
            <option data-idtax="0" value="0"> - </option>
            <?php
                $sql = mysqli_query($conn1, "select idtax, kriteria, percentage, GROUP_CONCAT(kriteria,' (',percentage,'%)') as kriteria2 from mtax where category_tax = 'PPH' GROUP BY idtax");
                foreach ($sql as $pph) :
            ?>
                <option data-idtax="<?= $pph['idtax']; ?>" value="<?= $pph['percentage']; ?>"><?= $pph['kriteria2']; ?></option>
            <?php endforeach; ?>
        </select>
    </td>

    <td style="width: 50px">
        <select class="form-control select2add" name="ppnn" data-live-search="true" onchange="input_ppn()" data-width="150px" data-size="5">
            <option data-idtax="0" value="0"> - </option>
            <?php
                $sql = mysqli_query($conn1, "select idtax, kriteria, percentage, GROUP_CONCAT(kriteria,' (',percentage,'%)') as kriteria2 from mtax where category_tax = 'PPN' GROUP BY idtax");
                foreach ($sql as $ppn) :
            ?>
                <option data-idtax="<?= $ppn['idtax']; ?>" value="<?= $ppn['percentage']; ?>"><?= $ppn['kriteria2']; ?></option>
            <?php endforeach; ?>
        </select>
    </td>
