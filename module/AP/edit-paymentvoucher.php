            ...
            <label for="ct_buyer"><b>Charge To Buyer</b></label>            
              <select class="form-control select2" name="ct_buyer" id="ct_buyer" style="width:100%">
                ...
                <div class="col-md-2 mb-3" id="div_tocc" style="padding-top: 8px;">
                    ...
                    <input type="text" class="form-control tocc-manual-input" id="tocc_manual" name="tocc_manual" style="width:100%; display:none;" placeholder="Enter To Account" autocomplete="off" value="<?= htmlspecialchars($toccVal); ?>">
                </div>
        </div>
        </br>
<div class="form-row">
 ...
 <div class="form-row">
    ...
    <tbody id="tbody2">
        ...
        foreach ($pvDetails as $d) {
            ...
            $dFakturPajak = $d['faktur_pajak'] ?? '';
            $dTglFakturPajak = (!empty($d['tgl_faktur_pajak']) && $d['tgl_faktur_pajak'] !== '0000-00-00' && date('Y-m-d', strtotime($d['tgl_faktur_pajak'])) !== '1970-01-01') ? date('d-m-Y', strtotime($d['tgl_faktur_pajak'])) : '';
        ...
        <tr>
            ...
            <td><input style="font-size: 12px;" type="text" class="form-control faktur_pajak" name="faktur_pajak[]" value="<?= htmlspecialchars($dFakturPajak); ?>" placeholder="" autocomplete="off"></td>
            <td><input type="text" style="font-size: 12px;" name="tgl_faktur_pajak" class="form-control tanggal tgl_faktur_pajak" value="<?= htmlspecialchars($dTglFakturPajak); ?>" autocomplete="off" placeholder="dd-mm-yyyy"></td>
