...
if (!empty($type_pv)) {
    ...
    // Build set of no_kbon already in this PL (to exclude from Section B)
    ...
    $alreadyListed = [];
    $sqlListed = mysqli_query($conn2, "SELECT no_kbon FROM pv_payment_list_det WHERE pl_number != '$pl_esc' AND status != 'Cancel'");
