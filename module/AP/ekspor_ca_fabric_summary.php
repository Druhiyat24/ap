...
while($row2 = mysqli_fetch_array($sql)){
    ...
    $total_sal_price = ($total_sal_qty != 0) ? round($total_sal_nilai_ / $total_sal_qty,2) : 0;
    ...
    <td style="text-align : right;" value = "'.$total_sal_nilai_.'">'.number_format($total_sal_nilai_,2).'</td>
