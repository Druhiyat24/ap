...
<body>
    ...
    <table style="width:100%;font-size:10px;" border="1" width="100%">
        ...
        while($row2 = mysqli_fetch_array($sql)){
            ...
            <td style="text-align : right;" value = "'.$row2['price'].'">'.$row2['price'].'</td>
            <td style="text-align : right;" value = "'.$row2['price_act'].'">'.$row2['price_act'].'</td>
            <td style="text-align : left;" value = "'.$row2['tipe_pembelian'].'">'.$row2['tipe_pembelian'].'</td>
            <td style="text-align: right;" value="' . ($row2['price_non_subkon'] == 0 ? $row2['nilai_barang'] : $row2['price_non_subkon']) . '">'
            .($row2['price_non_subkon'] == 0 ? $row2['nilai_barang'] : $row2['price_non_subkon'])
            . '</td>
            <td style="text-align : right;" value = "'.$row2['jasa_subkon'].'">'.$row2['jasa_subkon'].'</td>
            <td style="text-align : right;" value = "'.$row2['total_price'].'">'.$row2['total_price'].'</td>
            <td style="text-align: right;" value="' . ($row2['total_non_subkon'] == 0 ? $row2['total_nilai_barang'] : $row2['total_non_subkon']) . '">'
            . number_format(($row2['total_non_subkon'] == 0 ? $row2['total_nilai_barang'] : $row2['total_non_subkon']), 2)
            . '</td>
            ...
            <td style="text-align: right;" value="' . ($row2['total_non_subkon_idr'] == 0 ? $row2['total_nilai_barang_idr'] : $row2['total_non_subkon_idr']) . '">'
            . number_format(($row2['total_non_subkon_idr'] == 0 ? $row2['total_nilai_barang_idr'] : $row2['total_non_subkon_idr']), 2)
            . '</td>
