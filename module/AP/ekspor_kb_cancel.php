...
<body>
    ...
    <!--     <center>
 -->        <h4>DATA KONTRABON <br/> <?php echo strtoupper($nama_supp); ?><br/> PERIODE <?php echo strtoupper($start_date); ?> - <?php echo strtoupper($end_date); ?></h4>
<!--     </center>
