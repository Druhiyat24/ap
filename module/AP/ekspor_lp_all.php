...
<body>
    ...
    header("Content-Disposition: attachment; filename=List-Payment.xls");
...
<!-- 
    <center> -->
        <h4>DATA LIST PAYMENT <br/><?php if($nama_supp == 'ALL'){ echo strtoupper($nama_supp); echo " SUPPLIER";} else{ echo strtoupper($nama_supp); } ?> <br/> PERIODE <?php echo strtoupper($start_date); ?> - <?php echo strtoupper($end_date); ?></h4>
<!--     </center>
