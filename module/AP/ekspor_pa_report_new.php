...
<body>
    ...
    <h4>PURCHASE ADVANCE REPORT <br/> PROFIT CENTER: <?php echo $profit_center; ?> <br/> PERIODE: <?php echo $start_date; ?> - <?php echo $end_date; ?></h4>
    ...
    <table style="width:100%;font-size:10px;" border="1" width="100%">
        ...
        // 3 no_ftr di bawah ini SENGAJA dikecualikan dari floor tsb (sama spt
        // purchase_advance_report.php, kasus over-deduction Jun-Jul 2026) supaya
        // saldo minusnya ikut ter-carry apa adanya ke periode berikutnya di Excel
        // juga. FTR lain yang minus (di luar 3 ini) TETAP di-floor ke 0.
