...
<body>
    ...
    <h4>LIST PETTY CASH OUT <br/> <?php if($reference == 'ALL'){ echo 'ALL'; echo " REFERENCE "; } else { echo htmlspecialchars(strtoupper($reference)); } ?> <br/> PERIODE <?php echo htmlspecialchars(strtoupper($start_date)); ?> - <?php echo htmlspecialchars(strtoupper($end_date)); ?></h4>
