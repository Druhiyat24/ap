...
$update1 = mysqli_query($conn2, "update kontrabon_cbd set status = 'FIRST APPROVED' where no_kbon = '$no_kbon_esc'");
if (!$update1) {
    echo 'Error: ' . mysqli_error($conn2);
    exit;
}

$update2 = mysqli_query($conn2, "update kontrabon_h_cbd set status = 'FIRST APPROVED', first_approve_user = '$approve_user_esc', first_approve_date = '$first_approve_date' where no_kbon = '$no_kbon_esc'");
if (!$update2) {
    echo 'Error: ' . mysqli_error($conn2);
    exit;
}
