...
<div class="box footer">   
        <form id="form-simpan">
           <div class="form-row col">
            ...
            <button type="button" style="border-radius: 6px" class="btn-outline-warning" name="batal" id="batal" onclick="location.href='bpb_received.php'"><span class="fa fa-angle-double-left"></span> Back</button>         
            </div>
            </div>                                   
        </form>
        </div>        
