...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fas fa-thumbs-up"></i> APPROVAL REVERSE PETTY CASH <span class="badge bg-danger ms-2">
...
<div class="card-body p-3">
    <form id="form-data" action="form_approve_reverse_petty_cash.php"method="post">
        <div class="row g-3">
          <!-- Supplier -->
          <div class="col-md-3">
...
<div class="card shadow border-0 mt-4">
    <div class="card-body p-4">
      ...
      <tbody>
        ...
        $sql = mysqli_query($conn2,"select rvs_number, rvs_date, type_doc, deskripsi, status, created_by, created_date from ap_reverse_h where status = 'DRAFT' and rvs_number like '%PC/%' $where");
                ...
                if(processed === total){
                    if(errors === 0){
                        Swal.fire({
                            ...
                            window.location = 'form_approve_reverse_petty_cash.php';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
...
<script type="text/javascript">
    document.getElementById('btncreate').onclick = function () {
        location.href = "form_approve_reverse_petty_cash.php";
    };
</script>
