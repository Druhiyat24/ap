          ...
          <div class="card-body">
            <div class="form-row">
              ...
              <div class="col-md-2 mb-2">
                ...
                <input type="text" name="tgl_active3" id="tgl_active3" class="form-control tanggal" value="<?= date("d-m-Y", strtotime($row['tgl_pci'])); ?>" autocomplete="off">
              </div>

              <div class="col-md-3 mb-2">
                <label><b>Profit Center</b></label>
                <input type="text" class="form-control" id="profit_center_kas_show3" value="<?= htmlspecialchars($row['nama_pc']); ?>" readonly>
                <input type="hidden" id="profit_center_kas3" name="profit_center_kas3" value="<?= htmlspecialchars($row['profit_center_calc']); ?>">
              </div>
              ...
              <div class="col-md-3 mb-2">
                ...
                <select class="form-control select2" id="account3" name="account3" data-live-search="true">
                  <option value="<?= htmlspecialchars($row['coa_akun']); ?>" selected data-kode3="<?= htmlspecialchars($row['kode_cash']); ?>" data-pc3="<?= htmlspecialchars($row['profit_center_calc']); ?>" data-namapc3="<?= htmlspecialchars($row['nama_pc']); ?>"><?= htmlspecialchars($row['nama_akun']); ?></option>
                  <?php
                  ...
                  while ($racc = mysqli_fetch_assoc($sqlacc)) {
                      echo "<option value='" . $racc['id_coa'] . "' data-kode3='" . $racc['kode_cash'] . "' data-pc3='" . $racc['profit_center'] . "' data-namapc3='" . $racc['nama_pc'] . "'>" . $racc['coa'] . " </option>";
                  }
                  ?>
                </select>
              </div>
              ...
              <div class="col-md-2 mb-2">
                ...
                <input type="text" class="form-control" id="currency3" name="currency3" value="<?= htmlspecialchars($row['curr']); ?>" readonly>
              </div>

              <div class="col-md-2 mb-2">
                <label><b>Amount</b></label>
                <input type="text" class="form-control angka" id="amount_kas3" name="amount_kas3" value="<?= number_format($row['amount'], 0); ?>">
              </div>
            ...
            <div class="card-body p-2">
              <div class="table-responsive">
                <table id="mytablenone" class="table table-striped table-bordered table-hover table-sm nowrap">
                  ...
                  <tbody id="tbody3">
                    ...
                    while ($d = mysqli_fetch_assoc($sql_det)) {
                        ...
                        ?>
                    <tr>
                      <td><input type="checkbox" name="select[]" value="" checked disabled></td>

                      <td>
                        <select class="form-control selectpicker no_coa" name="nomor_coa[]" data-live-search="true" data-width="100%" data-size="5">
                      ...
                      <td>
                        <select class="form-control selectpicker prof_ctr" name="prof_ctr[]" data-live-search="true" data-width="100%">
                      ...
                      <td>
                        <select class="form-control selectpicker cost_ctr" name="cost_ctr[]" data-live-search="true" data-width="100%">
                      ...
                      <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="buyer[]" value="<?= htmlspecialchars($d['buyer']); ?>" autocomplete="off"></td>

                      <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="no_ws[]" value="<?= htmlspecialchars($d['no_ws']); ?>" autocomplete="off"></td>
                      ...
                      <td><input style="text-align:right;width:100%" type="number" min="1" class="form-control" name="txt_amount[]" value="<?= $d['t_debit']; ?>" oninput="modal_input_amt(this)" <?= $d['t_debit'] == 0 ? 'readonly' : ''; ?> autocomplete="off"></td>

                      <td><input style="text-align:right;width:100%" type="number" min="1" class="form-control" name="txt_credit[]" value="<?= $d['t_credit']; ?>" oninput="modal_input_cre(this)" <?= $d['t_credit'] == 0 ? 'readonly' : ''; ?> autocomplete="off"></td>

                      <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="keterangan[]" value="<?= htmlspecialchars($d['keterangan']); ?>" autocomplete="off"></td>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="11" align="center">
                        ...
                        <button type="button" class="btn btn-warning" onclick="InsertRow('tbody3')">Insert Row</button>
                  ...
                  <div class="total-box-body">
                    <div class="total-stat is-debit">
                      ...
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_debit_nag" readonly>
                        <input type="hidden" id="h_tot_debit_nag" readonly>
                      </div>
                    </div>
                    <div class="total-stat is-credit">
                      <span class="total-stat-label">Total Credit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_credit_nag" readonly>
                        <input type="hidden" id="h_tot_credit_nag" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="total-box tone-nak">
                  ...
                  <div class="total-box-body">
                    <div class="total-stat is-debit">
                      <span class="total-stat-label">Total Debit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_debit_nak" readonly>
                        <input type="hidden" id="h_tot_debit_nak" readonly>
                      </div>
                    </div>
                    <div class="total-stat is-credit">
                      <span class="total-stat-label">Total Credit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_credit_nak" readonly>
                        <input type="hidden" id="h_tot_credit_nak" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="total-box tone-all">
                  ...
                  <div class="total-box-body">
                    <div class="total-stat is-debit">
                      <span class="total-stat-label">Total Debit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_debit" readonly>
                        <input type="hidden" id="h_tot_debit" readonly>
                      </div>
                    </div>
                    <div class="total-stat is-credit">
                      <span class="total-stat-label">Total Credit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_credit" readonly>
                        <input type="hidden" id="h_tot_credit" readonly>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="form-row">
              <div class="col-md-3 mt-3 mb-2">
                <button type="button" style="border-radius: 6px" class="btn-outline-primary btn-sm" id="simpan3"><span class="fa fa-floppy-o"></span> Save</button>
...
`;
  ...
  $('#simpan3').on('click', function() {
    ...
    let header_pc = $('#profit_center_kas3').val();
    let header_debit = parseFloat($('#amount_kas3').val().replace(/,/g, '')) || 0;

    if (header_pc == 'NAG') {
      if (header_debit != creditNAG) {
        Swal.fire('Warning', 'Journal Nirwana Alabare Garment tidak balance', 'warning');
        return;
      }
    }
    ...
    if (header_pc == 'NAK') {
      if (header_debit != creditNAK) {
        Swal.fire('Warning', 'Journal Nirwana Alabare Knitting tidak balance', 'warning');
        return;
      }
    }

    function doUpdatePettyinNone3() {

      $('#simpan3').prop('disabled', true);

      $.ajax({
        url: "petty-in/update_pci_none.php",
        type: "POST",
        ...
        success: function(res) {
          ...
          if (r.status == 'success') {
            ...
            Swal.fire({
              ...
              if (retry.isConfirmed) { doUpdatePettyinNone3(); }
              else { $('#simpan3').prop('disabled', false); }
            });
          }
        },
