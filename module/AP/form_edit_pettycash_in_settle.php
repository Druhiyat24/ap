...
<div class="container-fluid mt-4 p-4">
  <div class="card shadow border-0">
    <div class="card-header text-white py-2 px-3" style="background: linear-gradient(90deg, #191970, #1e90ff);">
      <h5 class="mb-0"><i class="fas fa-edit"></i> FORM PETTY CASH IN - EDIT (SETTLEMENT)</h5>
    </div>
          ...
          <div class="card-body">
            <div class="form-row">
              ...
              <div class="col-md-2 mb-2">
                ...
                <input type="text" name="tgl_active2" id="tgl_active2" class="form-control tanggal" value="<?= date("d-m-Y", strtotime($row['tgl_pci'])); ?>" autocomplete="off">
              </div>

              <div class="col-md-3 mb-2">
                <label><b>Profit Center</b></label>
                <input type="text" class="form-control" id="profit_center_kas_show2" value="<?= htmlspecialchars($row['nama_pc']); ?>" readonly>
                <input type="hidden" id="profit_center_kas2" name="profit_center_kas2" value="<?= htmlspecialchars($row['profit_center_calc']); ?>">
              </div>
              ...
              <div class="col-md-3 mb-2">
                ...
                <select class="form-control select2" id="account2" name="account2" data-live-search="true">
                  <option value="<?= htmlspecialchars($row['coa_akun']); ?>" selected data-kode2="<?= htmlspecialchars($row['kode_cash']); ?>" data-pc2="<?= htmlspecialchars($row['profit_center_calc']); ?>" data-namapc2="<?= htmlspecialchars($row['nama_pc']); ?>"><?= htmlspecialchars($row['nama_akun']); ?></option>
                  <?php
                  ...
                  while ($racc = mysqli_fetch_assoc($sqlacc)) {
                      echo "<option value='" . $racc['id_coa'] . "' data-kode2='" . $racc['kode_cash'] . "' data-pc2='" . $racc['profit_center'] . "' data-namapc2='" . $racc['nama_pc'] . "'>" . $racc['coa'] . " </option>";
                  }
                  ?>
                </select>
              </div>
              ...
              <div class="col-md-2 mb-2">
                ...
                <input type="text" class="form-control" id="currency2" name="currency2" value="<?= htmlspecialchars($row['curr']); ?>" readonly>
              </div>
              ...
              <div class="col-md-2 mb-2">
                ...
                <input type="text" class="form-control angka" id="amount_kas2" name="amount_kas2" value="<?= number_format($row['amount'], 0); ?>">
              </div>
              ...
              <div class="col-md-8 mb-2">
                ...
                <textarea style="font-size: 15px; text-align: left;" cols="30" rows="3" class="form-control" name="pesan2" id="pesan2" placeholder="descriptions..." required><?= htmlspecialchars($row['deskripsi']); ?></textarea>
              </div>
            ...
            <div class="card-body p-2">
              <div class="table-responsive">
                <table id="mytablesettle" class="table table-striped table-bordered table-hover table-sm nowrap">
                  ...
                  <tbody id="tbody2">
                    ...
                    while ($d = mysqli_fetch_assoc($sql_det)) {
                        ...
                        ?>
                    <tr>
                      <td><input type="checkbox" name="select2[]" value="" checked disabled></td>
                      ...
                      <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="buyer2[]" value="<?= htmlspecialchars($d['buyer']); ?>" autocomplete="off"></td>

                      <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="no_ws2[]" value="<?= htmlspecialchars($d['no_ws']); ?>" autocomplete="off"></td>
                      ...
                      <td><input style="text-align:right;width:100%" type="number" min="1" class="form-control" name="txt_amount2[]" value="<?= $d['t_debit']; ?>" oninput="modal_input_amt2(this)" <?= $d['t_debit'] == 0 ? 'readonly' : ''; ?> autocomplete="off"></td>

                      <td><input style="text-align:right;width:100%" type="number" min="1" class="form-control" name="txt_credit2[]" value="<?= $d['t_credit']; ?>" oninput="modal_input_cre2(this)" <?= $d['t_credit'] == 0 ? 'readonly' : ''; ?> autocomplete="off"></td>

                      <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="keterangan2[]" value="<?= htmlspecialchars($d['keterangan']); ?>" autocomplete="off"></td>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="11" align="center">
                        <button type="button" class="btn btn-primary" onclick="addRow2('tbody2')">Add Row</button>
                        <button type="button" class="btn btn-warning" onclick="InsertRow2('tbody2')">Insert Row</button>
                        <button type="button" class="btn btn-danger" onclick="deleteRow2('tbody2')">Delete Row</button>
                      </td>
                    </tr>
                  </tfoot>
                  ...
                  <div class="total-box-body">
                    <div class="total-stat is-debit">
                      ...
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_debit_nag2" readonly>
                        <input type="hidden" id="h_tot_debit_nag2" readonly>
                      </div>
                    </div>
                    <div class="total-stat is-credit">
                      <span class="total-stat-label">Total Credit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_credit_nag2" readonly>
                        <input type="hidden" id="h_tot_credit_nag2" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="total-box tone-nak">
                  ...
                  <div class="total-box-body">
                    <div class="total-stat is-debit">
                      <span class="total-stat-label">Total Debit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_debit_nak2" readonly>
                        <input type="hidden" id="h_tot_debit_nak2" readonly>
                      </div>
                    </div>
                    <div class="total-stat is-credit">
                      <span class="total-stat-label">Total Credit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_credit_nak2" readonly>
                        <input type="hidden" id="h_tot_credit_nak2" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="total-box tone-all">
                  ...
                  <div class="total-box-body">
                    <div class="total-stat is-debit">
                      <span class="total-stat-label">Total Debit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_debit2" readonly>
                        <input type="hidden" id="h_tot_debit2" readonly>
                      </div>
                    </div>
                    <div class="total-stat is-credit">
                      <span class="total-stat-label">Total Credit</span>
                      <div class="total-stat-value-wrap">
                        <input type="text" class="total-stat-value" id="tot_credit2" readonly>
                        <input type="hidden" id="h_tot_credit2" readonly>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="form-row">
              <div class="col-md-3 mt-3 mb-2">
                <button type="button" style="border-radius: 6px" class="btn-outline-primary btn-sm" id="simpan2"><span class="fa fa-floppy-o"></span> Save</button>
...
`;
  ...
  function hitung_total2() {
    ...
    $('#tbody2 tr').each(function() {
      ...
      let debit = parseFloat($(this).find('input[name="txt_amount2[]"]').val()) || 0;
      let credit = parseFloat($(this).find('input[name="txt_credit2[]"]').val()) || 0;
  ...
  $('#simpan2').on('click', function() {
    ...
    let header_pc = $('#profit_center_kas2').val();
    let header_debit = parseFloat($('#amount_kas2').val().replace(/,/g, '')) || 0;
    ...
    function doUpdatePettyinSettle2() {

      $('#simpan2').prop('disabled', true);

      $.ajax({
        url: "petty-in/update_pci_settle.php",
        type: "POST",
        ...
        success: function(res) {
          ...
          if (r.status == 'success') {
            ...
            Swal.fire({
              ...
              if (retry.isConfirmed) { doUpdatePettyinSettle2(); }
              else { $('#simpan2').prop('disabled', false); }
            });
          }
        },
