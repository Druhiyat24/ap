...
$sqlH = mysqli_query($conn2, "select a.*, concat(a.coa_akun,' ',b.nama_coa) nama_akun from c_petty_cashout_h a left join mastercoa_v2 b on b.no_coa = a.coa_akun where a.no_pco = '$doc_num_esc' and a.reff = 'Settlement'");
...
<form id="form-data2" method="post">
    <input type="hidden" id="doc_num2" value="<?= htmlspecialchars($doc_num); ?>">
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <select class="form-control select2" id="account2" name="account2" data-live-search="true">
                        ...
                        while ($row = mysqli_fetch_assoc($sql)) {
                            ...
                            echo "<option value='" . $row['id_coa'] . "' data-kode2='" . $row['kode_cash'] . "' data-pc2='" . $row['profit_center'] . "' data-namapc2='" . $row['nama_pc'] . "' $selected>" . $row['coa'] . " </option>";
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="col-md-2 mb-2">
                    ...
                    <input type="text" class="form-control" id="currency2" name="currency2" value="<?= htmlspecialchars($rowH['curr']); ?>" readonly>
                    <input type="hidden" class="form-control" id="kode_kas2" name="kode_kas2" value="<?= htmlspecialchars($rowPcAkun['kode_cash'] ?? ''); ?>" readonly>
                    <input type="hidden" class="form-control" id="profit_center_kas2" name="profit_center_kas2" value="<?= htmlspecialchars($rowPcAkun['profit_center'] ?? ''); ?>" readonly>
                </div>
                    ...
                    <table id="mytablesettle"
                        ...
                        <tbody id="tbody2">
                            ...
                            while ($rowDet = mysqli_fetch_assoc($sqlDet)) {
                                ...
                                <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="buyer2[]" value="<?= htmlspecialchars($rowDet['buyer']); ?>" autocomplete="off"></td>

                                <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="no_ws2[]" value="<?= htmlspecialchars($rowDet['no_ws']); ?>" autocomplete="off"></td>
                                ...
                                <td><input style="text-align:right;width:100%" type="number" min="1" class="form-control" name="txt_amount2[]" value="<?= $rowDet['t_debit'] > 0 ? $rowDet['t_debit'] : ''; ?>" <?= $rowDet['t_debit'] == 0 ? 'readonly' : ''; ?> oninput="modal_input_amt2(this)" autocomplete="off"></td>

                                <td><input style="text-align:right;width:100%" type="number" min="1" class="form-control" name="txt_credit2[]" value="<?= $rowDet['t_credit'] > 0 ? $rowDet['t_credit'] : ''; ?>" <?= $rowDet['t_credit'] == 0 ? 'readonly' : ''; ?> oninput="modal_input_cre2(this)" autocomplete="off"></td>

                                <td><input style="font-size:12px;width:100%" type="text" class="form-control" name="keterangan2[]" value="<?= htmlspecialchars($rowDet['keterangan']); ?>" autocomplete="off"></td>
                        ...
                        <div class="total-box-body">
                            ...
                            <div class="total-stat is-debit">
                                ...
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_debit_nag2" name="tot_debit_nag2" readonly>
                                    <input type="hidden" id="h_tot_debit_nag2" name="h_tot_debit_nag2" readonly>
                                </div>
                            </div>
                            ...
                            <div class="total-stat is-credit">
                                ...
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_credit_nag2" name="tot_credit_nag2" readonly>
                                    <input type="hidden" id="h_tot_credit_nag2" name="h_tot_credit_nag2" readonly>
                                </div>
                            </div>
                    ...
                    <div class="total-box tone-nak">
                        ...
                        <div class="total-box-body">
                            ...
                            <div class="total-stat is-debit">
                                <span class="total-stat-label">Total Debit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_debit_nak2" name="tot_debit_nak2" readonly>
                                    <input type="hidden" id="h_tot_debit_nak2" name="h_tot_debit_nak2" readonly>
                                </div>
                            </div>
                            ...
                            <div class="total-stat is-credit">
                                <span class="total-stat-label">Total Credit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_credit_nak2" name="tot_credit_nak2" readonly>
                                    <input type="hidden" id="h_tot_credit_nak2" name="h_tot_credit_nak2" readonly>
                                </div>
                            </div>
                    ...
                    <div class="total-box tone-all">
                        ...
                        <div class="total-box-body">
                            ...
                            <div class="total-stat is-debit">
                                <span class="total-stat-label">Total Debit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_debit2" name="tot_debit2" readonly>
                                    <input type="hidden" id="h_tot_debit2" name="h_tot_debit2" readonly>
                                </div>
                            </div>
                            ...
                            <div class="total-stat is-credit">
                                <span class="total-stat-label">Total Credit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_credit2" name="tot_credit2" readonly>
                                    <input type="hidden" id="h_tot_credit2" name="h_tot_credit2" readonly>
                                </div>
                            </div>
...
function updateCostCenter2(profCtr, noCoa, row) {
  const costCtrDropdown = $(row).find('.cost_ctr2');
...
$('#simpan2').on('click', function () {
    ...
    $("#tbody2 tr").each(function(){
        ...
        let buyer = tr.find('input[name="buyer2[]"]').val();
        let ws    = tr.find('input[name="no_ws2[]"]').val();
        let currency = tr.find('select.curr_det2').first().val();
    ...
    function doUpdateSettle2(){
        ...
        $.ajax({
            type: "POST",
            url: "petty-out/update_pettyout_settle.php",
