...
<?php
// Payment Voucher List - clone dari Payment List, hanya 1 tahap approval.
// PV yang sudah pernah dimasukkan ke Payment List ATAU Payment Voucher List
// lain (status != 'Cancel' di kedua _det table) disembunyikan dari hasil
// search ini, supaya tidak ada PV yang diklaim dua kali oleh dua feature ini.
...
<div class="container-fluid mt-2 p-3" style="padding-left: 2rem; padding-right: 2rem;">
  ...
  <div class="card shadow mb-5" style="border: 1px solid #e2e8f0; border-radius: 10px;">
    <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #191970, #1e90ff); border: none; font-weight: 700; letter-spacing: 0.4px; color: #fff; cursor: pointer;" data-toggle="collapse" data-target="#pl_header_card_body" aria-expanded="true" aria-controls="pl_header_card_body">
        <span><i class="fab fa-wpforms mr-2"></i> FORM PAYMENT VOUCHER LIST</span>
    ...
    <form id="form-data" method="post">
        <div class="form-row mt-2">
            ...
            <div class="col-md-2 mb-3">
                <label for="pl_date"><b>Payment Voucher List Date <i style="color: red;">*</i></b></label>
            ...
            <form id="form-simpan">
                <div class="form-row col mt-3">
                    <div class="col-md-3 mb-3">
                        ...
                        <button type="button" style="border-radius: 6px" class="btn-danger btn-sm" name="batal" id="batal" onclick="location.href='payment-voucher-list.php'"><span class="fa fa-angle-double-left"></span> Back</button>
                    </div>
                </div>
            </form>
        </div>
