...
<form id="form-data" action="formapprovebpb.php" method="post">
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select id, no_bpb, tgl_bpb, create_date, pono, supplier, top, curr, confirm1, tgl_po, SUM((qty * price) + ((qty * price) * (tax /100))) as total from bpb_new where confirm2 = '' and profit_center = 'NAG' and status != 'Cancel' group by no_bpb");                
            }else {
            $sql = mysqli_query($conn2,"select id, no_bpb, tgl_bpb, create_date, pono, supplier, top, curr, confirm1, tgl_po, SUM((qty * price) + ((qty * price) * (tax /100))) as total from bpb_new where supplier = '$nama_supp' and confirm2 = '' and profit_center = 'NAG' and status != 'Cancel' group by no_bpb");
            }
