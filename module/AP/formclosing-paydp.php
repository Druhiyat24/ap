...
<form id="form-data" action="formclosing-paydp.php" method="post">
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select a.no_payment, a.tgl_payment, a.nama_supp, a.curr, sum(a.amount) as amount, a.status, b.payment_ftr_id, b.tgl_pelunasan, b.cara_bayar, b.account, b.bank, b.valuta_bayar, b.nominal, b.nominal_fgn, b.ttl_bayar, tgl_tempo from list_payment_dp a left join payment_ftrdp b on b.list_payment_id = a.no_payment where a.`status` = 'Approved' group by a.no_payment");                
            }else {
            $sql = mysqli_query($conn2,"select a.no_payment, a.tgl_payment, a.nama_supp, a.curr, sum(a.amount) as amount, a.status, b.payment_ftr_id, b.tgl_pelunasan, b.cara_bayar, b.account, b.bank, b.valuta_bayar, b.nominal, b.nominal_fgn, b.ttl_bayar, tgl_tempo from list_payment_dp a left join payment_ftrdp b on b.list_payment_id = a.no_payment where a.`status` = 'Approved' and a.nama_supp = '$nama_supp' group by a.no_payment");
            }
