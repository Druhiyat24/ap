                ...
                <table id="datatable" class="table table-striped table-bordered text-nowrap" role="grid" cellspacing="0" width="100%">
                    ...
                    while($row = mysqli_fetch_array($sql)){
                        if (!empty($row)) {
                            ...
                            if ($status == 'Approved' && $group != 'STAFF' && $pur == '1') {
                                ...
                                <a href="pdf_ftrdp.php?noftrdp='.$row['no_ftr_dp'].'" target="_blank">
                                <button style="border-radius:4px; font-size:11px; padding:2px 6px;" type="button" class="btn btn-success btn-xs">
                                <i class="fa fa-file-pdf-o" aria-hidden="true" style="margin-right:3px;"></i>Pdf
                                </button>
                                </a>';

                            } elseif ($status == 'Approved' && $group == 'STAFF' && $pur == '1') {
                                echo '<a id="approve" href="">
                                <i class="fa fa-paper-plane" style="padding:0 3px;" hidden></i>
                                </a>
                                <a id="delete" href="">
                            ...
                            } elseif ($status == 'draft' && $group != 'STAFF' && $pur == '1') {
                                echo '<a id="approve" href="">
                                <button style="border-radius:4px; font-size:11px; padding:2px 6px;" type="button" class="btn btn-info btn-xs" onclick="alert_approve();">
                                <i class="fa fa-paper-plane" aria-hidden="true" style="margin-right:3px;"></i>Approve
                                </button>
                                </a>
                                <a id="delete" href="">
                                <button style="border-radius:4px; font-size:11px; padding:2px 6px;" type="button" class="btn btn-danger btn-xs">
                                <i class="fa fa-trash" aria-hidden="true" style="margin-right:3px;"></i>Cancel
                                </button>
                                </a>
                                <a href="pdf_ftrdp.php?noftrdp='.$row['no_ftr_dp'].'" target="_blank">
                                ...
                                echo '<a href="pdf_ftrdp.php?noftrdp='.$row['no_ftr_dp'].'" target="_blank">
                                <button style="border-radius:4px; font-size:11px; padding:2px 6px;" type="button" class="btn btn-success btn-xs">
                                <i class="fa fa-file-pdf-o" aria-hidden="true" style="margin-right:3px;"></i>Pdf
                                </button>
                                </a>';

                            } elseif ($status == 'Cancel' && $group != 'STAFF' && $pur == '1') {
                                echo '<p style="font-size:11px; margin-bottom:-1px;">
                                <i class="fa fa-ban fa-lg" style="margin-right:3px; color:red;"></i>
                                <b>Canceled</b>
                                </p>';
