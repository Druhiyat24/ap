...
$sql = mysqli_query($conn2, "select type_pv, no_kbon, tgl_kbon, nama_supp, curr, total, deskripsi from pv_payment_voucher_list_det where pl_number = '" . mysqli_real_escape_string($conn2, $pl_number) . "' and status != 'Cancel' order by id asc");
