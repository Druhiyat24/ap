...
if($amount != ''){
$query = "INSERT INTO c_cash_out (no_co, tgl_co, type_co, dokumen, no_coa, no_costcenter, buyer, ws, req_by, curr, amount, deskrip, status, deskrip_global, create_date, create_by,stat_pci, profit_center) 
VALUES 
	('$kode', '$tgl_co', '$type_co', '$dokumen', '$no_coa','$no_costcenter', '$buyer', '$ws', '$req_by', '$curr','$amount', '$deskrip', '$status', '$pesan', '$create_date', '$create_user', '$stat_pci', '$prof_ctr')";
...
VALUES 
   ('$kode', '$tgl_co', '$type_co', '$no_coa', '$nama_coa', '$no_costcenter', '$nama_cc', '$dokumen', '', '$buyer', '$ws', '$curr', '1', '$amount', '0', '$amount', '0', '$status', '$pesan', '$create_user', '$create_date', '', '', '', '', '$prof_ctr')";
