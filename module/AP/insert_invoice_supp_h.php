...
$query = "INSERT INTO ir_invoice_supp_h (doc_number, tgl_penerimaan, no_reff, nama_supp,total_amount,deskripsi,status,updated_at,created_by,created_date,unik_code) 
VALUES 
	('$kode', '$tgl_penerimaan', '$no_reff', '$nama_supp', '$total_amount', '$deskripsi', '$status', '$create_date', '$create_user', '$create_date', '$unik_code')";
