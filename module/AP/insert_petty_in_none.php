...
VALUES 
   ('$kode', '$tgl_pci', '$nomor_coa', '$prof_ctr', '$cost_ctr', '$buyer', '$no_ws', '$curre', '$debit', '$credit', '$keterangan')";
...
VALUES 
   ('$kode', '$tgl_pci', '$type_ci', '$nomor_coa', '$nama_coa', '$cost_ctr', '$nama_cc', '$txtno_pco', '$txttgl_pco', '$buyer', '$no_ws', '$curre', '1', '$debit', '$credit', '$debit', '$credit', 'Draft', '$keterangan', '$create_by', '$create_date', '', '', '', '', '$prof_ctr')";
...
$queryss = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center) 
VALUES 
   ('$kode', '$tgl_pci', '$type_ci', '$nomor_coa', '$nama_coa', '$cost_ctr', '$nama_cc', '$dokumen', '', '$buyer', '$no_ws', '$curre', '1', '$debit', '$credit', '$debit', '$credit', 'Draft', '$keterangan', '$create_by', '$create_date', '', '', '', '', '$prof_ctr')";
