...
$query = "INSERT INTO pv_payment_list_det (pl_number, type_pv, no_kbon, tgl_kbon, nama_supp, curr, total, deskripsi, profit_center, status, create_user, create_date)
VALUES
('$pl_number', '$type_pv', '$no_kbon', $tgl_kbon, '$nama_supp', '$curr', '$total', '$deskripsi', '$profit_center', 'Draft', '$create_user', '$create_date')";
$execute = mysqli_query($conn2, $query);

if ($execute) {
    // PV ini sekarang ikut sebuah PL yang masih Draft - tandai di table sumbernya.
    updateStatusPl($conn2, $type_pv, $no_kbon, 'Draft');
    echo 'OK';
} else {
