...
VALUES 
	('$no_bpb', '$no_po', '$ws', '$tgl_bpb', '$tgl_po', '$nama_supp', '$item', '$color', '$size', '$qty', '$uom', '$price', '$tax', '$curr', '$create_user', '$confirm1', '','$confirm_date','$invoiced', '$status', '$top', '$pterms', '$create_date', '$update_date', '$create_user', '$ceklist', '$start_date', '$end_date', '$id_item', '$id_supplier', '$profit_center') ");
