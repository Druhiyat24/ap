...
if ($list_payment_id != '') {
	...
	VALUES 
	('$payment_ftr_id', '$create_date', 'Payment Non Bank', '$coa_lp', '$nama_coa_lp', '-', '-', '$list_payment_id', '$tgl_list_payment', '-', '-', '$valuta_ftr', '$rate', '$nominal', '0', '$t_nominal', '0', 'Draft', '$pesan', '$create_user', '$create_date', '', '', '', '', '$profit_center', '$nama_supp_esc')";
...
if ($debit == '' and $credit == '') {
	...
	$queryss = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center, supplier) 
	VALUES 
	('$payment_ftr_id', '$create_date', 'Payment Non Bank', '$no_coa', '$nama_coa_tamb', '$no_coc', '$nama_coc_tamb', '$reff_doc', '$reff_date', '-', '-', '$valuta_ftr', '$rate', '$debit', '$credit', '$t_debit', '$t_credit', 'Draft', '$deskripsi', '$create_user', '$create_date', '', '', '', '', '$prof_ctr', '$nama_supp_esc')";
