...
while ($row = mysqli_fetch_assoc($sql)) {
    ...
    <td ><select class="form-control selectpicker" name="prof_ctr" id="prof_ctr" data-live-search="true" data-width="200px" data-size="5"> <option value="'.$row['profit_center'].'" >'.$row['nama_pc'].'</option></select></td>
    ...
    <td><input style="font-size: 12px;width: 150px;" type="text" class="form-control" name="keterangan[]" placeholder="" autocomplete="off" value="'.$row['buyer'].'"></td>
    <td><input style="font-size: 12px;width: 150px;" type="text" class="form-control" name="keterangan[]" placeholder="" autocomplete="off" value="'.$row['no_ws'].'"></td>
    ...
    <td><input style="text-align: right;" type="number" min="1" style="font-size: 12px;width: 150px;" class="form-control" id="txt_amount" name="txt_amount"  oninput="modal_input_amt(value)" autocomplete = "off" value="'.$row['debit'].'"></td>
    <td><input style="text-align: right;" type="number" min="1" style="font-size: 12px;width: 150px;" class="form-control" id="txt_credit" name="txt_credit" oninput="modal_input_cre(value)" autocomplete = "off" value="'.$row['credit'].'"></td>
    <td><input style="font-size: 12px;width: 150px;" type="text" class="form-control" name="keterangan[]" placeholder="" autocomplete="off" value="'.$row['deskripsi'].'"></td>
