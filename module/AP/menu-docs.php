            ...
            'ap-report' => [
                ...
                'doc' => [
                    ...
                    'notes' => [
                        ...
                        'Perbaikan (Sep 2026) - kolom <b>Deduction PPN</b> di tab Payment Voucher: baris akun PPN Masukan (1.52.04 billed &amp; 1.52.07 unbilled) di jurnal PV dulu tidak dihitung, sehingga PV yang PPN-nya dipotong menyisakan saldo gantung walau sudah lunas. Contoh: PV-AP/REG/NAG/2026/08/02062 (USD) - GR/IR 15.540, Uang Muka -4.662, PPN Unbilled -1.540, dibayar BK 9.338 -&gt; dulu tersisa 1.540, kini 0. Kolomnya BERTANDA: negatif memotong utang, positif menambah utang (mis. 02235: GR/IR hanya DPP 150.400 + PPN 16.544 = utang 166.944, dulu tertulis 150.400). Diuji ke 639 PV sejak Jul 2026: 637 cocok persis dgn utang usaha di jurnal, 2 sisanya selisih pembulatan data sumber (&lt; 1).',
                        'Tambalan lama "- diff_ppn" pada CTE potongan (Deduction Others) di <code>ap_report2/query_pv2.php</code> DIBUANG - tambalan itu hanya jalan kalau PV kebetulan punya baris akun BEBAN (dan terkurang sekali per baris BEBAN). JANGAN dipasang lagi bersamaan dgn kolom PPN: 40 PV akan terpotong dobel. Di tab ringkasan (Summary Supplier + ekspor semua sheet) potongan PPN digabung ke Deduction Others supaya layout tidak berubah dan rincian tetap menjumlah ke saldo akhir.',
