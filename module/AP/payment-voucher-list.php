...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fa fa-list-alt" aria-hidden="true"></i> PAYMENT VOUCHER LIST</h5>
</div>

<div class="card-body p-3">
  <form id="form-data" action="payment-voucher-list.php" method="post">
    <div class="row g-3">
        ...
        <div class="col-md-6 d-flex align-items-end mt-2">
          <button type="submit" class="btn btn-info btn-sm me-2">
            ...
            <button type="button" id="btncreate" class="btn btn-primary btn-sm ml-2">
...
<script type="text/javascript">
    var datatable = $('#mytable').DataTable({
        ...
        ajax: {
            url: 'ajx_payment-voucher-list.php',
            type: 'POST',
            data: function (d) {
                d.status     = $('#filter').val();
...
<script type="text/javascript">
    document.getElementById('btncreate').onclick = function () {
        location.href = "form_payment-voucher-list.php";
    };
</script>
...
<script type="text/javascript">
    $(document).on("click", ".btn-cancel-pl", function () {
        ...
        Swal.fire({
            title: "Are you sure?",
            text: "This Payment Voucher List will be cancelled, and all Payment Vouchers in it will be released for the next Payment Voucher List.",
            icon: "warning",
                ...
                $.ajax({
                    ...
                    success: function () {
                        Swal.fire({
                            icon: "success",
                            title: "Cancelled",
                            text: "Payment Voucher List has been cancelled successfully."
                        }).then(() => {
                            dataTableReload();
                        });
                    },
                    error: function () {
                        Swal.fire({ icon: "error", title: "Error", text: "Failed to cancel Payment Voucher List!" });
                    }
                });
            }
        });
