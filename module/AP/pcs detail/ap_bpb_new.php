 <div style="margin-left: 10px;margin-bottom: 10px;">
    ...
    echo '<a target="_blank" href="pcs_detail_bpb_new.php?nama_supp='.$nama_supp.'&&start_date='.$start_date.'&&end_date='.$end_date.'"><button type="button" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;font-size:11px"> EXCEL AP - BPB</i></button></a>';
    ?>
</div> 
...
<div class="tableFix" style="height: 350px;">        
    <table id="datatable" class="table table-striped table-bordered text-nowrap" style="font-size: 12px;" role="grid" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            elseif ($nama_supp == 'ALL' and !empty($start_date) and !empty($end_date)) {
               $sql = mysqli_query($conn1,"select * from(((select b.Supplier,a.bpbno_int,bpbdate,c.jml_pterms as top, DATE_ADD(a.bpbdate, INTERVAL c.jml_pterms DAY) as due_date,a.curr,round(sum((((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) + (((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) * (c.tax /100)))),2) as total from bpb a INNER JOIN po_header c on c.pono = a.pono INNER JOIN mastersupplier b on b.Id_Supplier = a.id_supplier left JOIN po_header_draft d on d.id = c.id_draft where a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com is null and bpbdate between '2022-04-14' and '$start_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680') || a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com IN ('REGULAR','') and bpbdate between '2022-04-14' and '$start_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680') || a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com = 'BUYER' and bpbdate between '2022-04-14' and '$start_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680') group by a.bpbno_int order by bpbdate asc)union (
                ...
                (select b.Supplier,a.bpbno_int,bpbdate,c.jml_pterms as top, DATE_ADD(a.bpbdate, INTERVAL c.jml_pterms DAY) as due_date,a.curr,round(sum((((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) + (((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) * (c.tax /100)))),2) as total from bpb a INNER JOIN po_header c on c.pono = a.pono INNER JOIN mastersupplier b on b.Id_Supplier = a.id_supplier left JOIN po_header_draft d on d.id = c.id_draft where a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com is null and bpbdate between '$start_date' and '$end_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680') || a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com IN ('REGULAR','') and bpbdate between '$start_date' and '$end_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680')|| a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com = 'BUYER' and bpbdate between '$start_date' and '$end_date' and b.tipe_sup != 'D' group by a.bpbno_int order by bpbdate asc) union (select c.Supplier,a.bppbno_int,a.bppbdate, '0' as top, '0000-00-00' as due_date,a.curr,ROUND(- SUM((a.qty * a.price)),2) as total from bppb a inner join mastersupplier c on c.Id_Supplier = a.id_supplier  where a.cancel != 'Y' and a.bpbno_ro != '' and a.confirm = 'Y' and a.bppbdate between '$start_date' and '$end_date' and c.tipe_sup != 'D' group by bppbno_int)
            ...
            $sql = mysqli_query($conn1,"select * from(((select b.Supplier,a.bpbno_int,bpbdate,c.jml_pterms as top, DATE_ADD(a.bpbdate, INTERVAL c.jml_pterms DAY) as due_date,a.curr,round(sum((((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) + (((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) * (c.tax /100)))),2) as total from bpb a INNER JOIN po_header c on c.pono = a.pono INNER JOIN mastersupplier b on b.Id_Supplier = a.id_supplier left JOIN po_header_draft d on d.id = c.id_draft where a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com is null and bpbdate between '2022-04-14' and '$start_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680') || a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com IN ('REGULAR','') and bpbdate between '2022-04-14' and '$start_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680') || a.r_ap is null and a.confirm = 'y' and c.app = 'A' and a.price != '0' and cancel = 'N' and d.tipe_com = 'BUYER' and bpbdate between '2022-04-14' and '$start_date' and b.tipe_sup != 'D' and bpbno_int not in ('GEN/IN/1125/02931','WIP/IN/1125/01633','WIP/IN/1125/01634','WIP/IN/1125/01639','WIP/IN/1125/01643','WIP/IN/1125/01656','GEN/IN/1225/03350','GEN/IN/1225/03351','GEN/IN/1125/02785', 'WIP/IN/1225/01680') group by a.bpbno_int order by bpbdate asc)union (
                ...
                union (select nama_supp, no_bpb, tgl_bpb, top, duedate, curr, total from tbl_tamb_bpb where tgl_bpb <= '$end_date')
                union (select nama_supp, no_bpb, tgl_bpb, top, duedate, curr, total from tbl_tamb_bpb2 where tgl_bpb <= '$end_date' )) as b where b.Supplier = '$nama_supp' order by b.Supplier asc");
        }
        ...
        $sqldel = "delete from rpt_ap_bpb where user_create = '$user'";
        $querydel = mysqli_query($conn1,$sqldel);

        $sqldel2 = "ALTER TABLE rpt_ap_bpb";
        ...
        while($row = mysqli_fetch_array($sql)){
            ...
            if ($no_bpb == 'GEN/RO/0722/00606' || $no_bpb == 'GEN/RO/0722/00623' || $no_bpb == 'GEN/RO/1225/00921' || $no_bpb == 'GEN/RO/1225/00891' || $no_bpb == 'GEN/RO/1225/00951' || $no_bpb == 'GEN/RO/0126/00101' || $no_bpb == 'GEN/RO/0126/00102') {
               $jml_tax = 0;  
    ...
    if($sa_awal == '0' and $tambah == '0' and $kurang == '0' and $sa_akhir == '0'){
        ...
        <td style="text-align:right;" value = "'.$total_reverse.'">'.number_format($total_reverse,2).'</td>
...
<th style="text-align: right;vertical-align: middle;">'.number_format($reverse,2).'</th>
