<div style="margin-left: 10px;margin-bottom: 10px;">
        ...
        echo '<a target="_blank" href="pcs_detail_sum_type2.php?nama_supp='.$nama_supp.' && start_date='.$start_date.' && end_date='.$end_date.' && user='.$user.'"><button type="button" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;font-size:11px;"> EXCEL ITEM TYPE 2 </i></button></a>';
        ?>
    </div> 
