...
if($sa_awal == '0' and $tambah == '0' and $kurang == '0' and $sa_akhir == '0'){
    ...
    <td style="text-align:right;" value = "'.$total_reverse.'">'.$total_reverse.'</td>
