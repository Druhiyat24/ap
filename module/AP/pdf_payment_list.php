...
$sqlDet = mysqli_query($conn2, "select id, type_pv, no_kbon, tgl_kbon, nama_supp, curr, total, deskripsi, profit_center from pv_payment_list_det where pl_number = '$pl_number_esc' and status != 'Cancel' order by nama_supp asc, no_kbon asc");
