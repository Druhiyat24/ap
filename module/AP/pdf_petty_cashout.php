...
$sqlys = "select no_coa,nama_coa,nama_costcenter,b.profit_center,reff_doc,reff_date,curr,debit,credit, keterangan from tbl_list_journal a left join b_master_cc b on b.no_cc = a.no_costcenter where debit > 0 and no_journal = '$no_pco' || credit > 0 and no_journal = '$no_pco'";
...
<body style=" padding-left:-5%; padding-right:-5%;">
  ...
  <tr style="line-height: 10px;">
      ...
      <th style="width: 10%;text-align:center;">Coa Name</th>
      <th style="width: 10%;text-align:center;">Cost Center</th>
      <th style="width: 10%;text-align:center;">Profit Center</th>
      <th style="width: 11%;text-align:center;">Reff Doc</th>
