...
VALUES
('$doc_num', '$doc_date', '$ref_num', '$reff_doc', '$oth_doc', '$akun', '$curr', '$amount', '$status', '$user', '$create_date', '$desc', '$cash_flow')
");
...
$detRows     = [];
$journalRows = ["('$doc_num', '$doc_date', '$ref_num', '$akun', '$nama_coa', '-', '-', '$reff_doc', '', '-', '-', 'IDR', '1', '$amount', '0', '$amount', '0', 'Draft', '$desc', '$user', '$create_date', '', '', '', '', '$pc_kas')"];
...
$journalRows[] = "('$doc_num', '$doc_date', '$ref_num', '$no_coa', '$nama_coa', '$cc_i', '$nama_cc', '$reff_doc', '', '$buyer_i', '$ws_i', '$curr_i', '1', '$d_debit', '$d_credit', '$d_debit', '$d_credit', 'Draft', '$ket_i', '$user', '$create_date', '', '', '', '', '$pc_i')";
...
dbExec($conn2, "update c_cash_out set stat_pci='Y' where no_co = '$reff_doc'");
