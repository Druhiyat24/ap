        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <input type="text" name="ref_num3" id="ref_num3" class="form-control" value="Advance" readonly>
                </div>
          ...
          <!--       <div class="col-md-3 mb-2">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <select class="form-control select2" name="cash_flow3" id="cash_flow3" data-live-search="true">
                        ...
                        <?php
                        $sqlCf3 = mysqli_query($conn2, "select id, show_subcategory from master_cash_flow where type_cashflow = 'Cash Out' and status = 'Y' order by nama_category asc, urutan asc");
                            ...
                            <tr>
                                <td colspan="11" align="center">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        onclick="addRow3('tbody3')">
                                        Add Row
                                    </button>

                                    <button type="button" class="btn btn-warning"
                                        onclick="InsertRow3('tbody3')">
                                        Insert Row
                                    </button>

                                    <button type="button" class="btn btn-danger"
                                        onclick="deleteRow3('tbody3')">
                                        Delete Row
                                    </button>
                        ...
                        <div class="total-box-body">
                            ...
                            <div class="total-stat is-debit">
                                ...
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_debit_nag3" name="tot_debit_nag3" readonly>
                                    <input type="hidden" id="h_tot_debit_nag3" name="h_tot_debit_nag3" readonly>
                                </div>
                            </div>
                            ...
                            <div class="total-stat is-credit">
                                ...
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_credit_nag3" name="tot_credit_nag3" readonly>
                                    <input type="hidden" id="h_tot_credit_nag3" name="h_tot_credit_nag3" readonly>
                                </div>
                            </div>
                    ...
                    <div class="total-box tone-nak">
                        ...
                        <div class="total-box-body">
                            ...
                            <div class="total-stat is-debit">
                                <span class="total-stat-label">Total Debit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_debit_nak3" name="tot_debit_nak3" readonly>
                                    <input type="hidden" id="h_tot_debit_nak3" name="h_tot_debit_nak3" readonly>
                                </div>
                            </div>
                            ...
                            <div class="total-stat is-credit">
                                <span class="total-stat-label">Total Credit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_credit_nak3" name="tot_credit_nak3" readonly>
                                    <input type="hidden" id="h_tot_credit_nak3" name="h_tot_credit_nak3" readonly>
                                </div>
                            </div>
                    ...
                    <div class="total-box tone-all">
                        ...
                        <div class="total-box-body">
                            ...
                            <div class="total-stat is-debit">
                                <span class="total-stat-label">Total Debit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_debit3" name="tot_debit3" readonly>
                                    <input type="hidden" id="h_tot_debit3" name="h_tot_debit3" readonly>
                                </div>
                            </div>
                            ...
                            <div class="total-stat is-credit">
                                <span class="total-stat-label">Total Credit</span>
                                <div class="total-stat-value-wrap">
                                    <input type="text" class="total-stat-value" id="tot_credit3" name="tot_credit3" readonly>
                                    <input type="hidden" id="h_tot_credit3" name="h_tot_credit3" readonly>
                                </div>
                            </div>
