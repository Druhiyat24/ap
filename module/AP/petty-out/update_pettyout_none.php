...
try {
    ...
    foreach ($detail as $row) {
        ...
        $journalRows[] = "('$doc_num_esc', '$doc_date', '$type_journal', '$coa', '$nama_coa_det', '$cc', '$nama_cc', '-', '', '$buyer', '$ws', '$curr_det', '1', '$debit', '$credit', '$debit', '$credit', 'Draft', '$desc2', '$user', '$edit_date', '', '', '', '', '$pc', '$nama_supp')";
    }
