...
try {
    ...
    // dokumen ini diedit ("Settlement (Rev 1)", "Settlement (Rev 2)", dst).
    // Kecuali kalau account (kode kas) berubah sampai dokumen akan
    // di-renumber di akhir - reset lagi ke nama dasar.
    // =========================
    ...
    dbExec($conn2, "
        ...
        SET tgl_pco = '$doc_date', coa_akun = '$akun', curr = '$curr', amount = '$amount', deskripsi = '$desc', id_cash_flow = '$cash_flow'
        WHERE no_pco = '$doc_num_esc'
        ");

    dbExec($conn2, "
        UPDATE c_report_pettycash
        SET transaksi_date = '$doc_date', credit = '$amount', deskripsi = '$desc', id_cash_flow = '$cash_flow'
