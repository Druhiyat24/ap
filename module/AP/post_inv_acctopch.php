<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h3 class="text-center">TRANSFER INVOICE FROM ACCOUNTING TO PURCHASING</h3>
<div class="box">
...
<form id="form-data" method="post">
        <div class="form-row">
            ...
            <?php
            $sql = mysqli_query($conn2,"select max(substr(no_trans,15)) no_trans from ir_log_trans where kode_trans = 'TATP'");
