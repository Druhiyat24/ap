...
FROM
   ...
   while($row = mysqli_fetch_array($sql)){
    ...
    if ($isFxRow) {
        ...
        // Rate IKUT JURNAL (bisa manual, beda dari masterrate PAJAK): ambil rate baris
        // bank di tbl_list_journal (no_journal = no_doc, no_coa = COA bank). Fallback
        // ke masterrate PAJAK hanya bila baris jurnalnya belum ada.
        $ratepjk = null;
        if ($bank_coa !== '') {
