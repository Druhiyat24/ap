...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fas fa-history"></i> REVERSE KONTRABON</h5>
</div>

<div class="card-body p-3">
  <form id="form-data" action="reverse_kontrabon.php" method="post">
    <div class="row g-3">
      <!-- Supplier -->
      <div class="col-md-4">
...
<?php
$querys = mysqli_query($conn2,"select useraccess.menu as menu,useraccess.username as username, useraccess.fullname as fullname, menurole.id as id from useraccess inner join menurole on menurole.menu = useraccess.menu where username = '$user' and useraccess.menu = 'Create Reverse Kontrabon'");
...
<div class="card shadow border-0 mt-4">
    <div class="card-body p-4">
      ...
      <tbody>
        ...
        $sql = mysqli_query($conn2,"select rvs_number, rvs_date, type_doc, deskripsi, status, created_by, created_date from ap_reverse_h where rvs_date BETWEEN '$start_date' AND '$end_date' and rvs_number like '%SI/%' $where");
...
<script type="text/javascript">
    document.getElementById('btncreate').onclick = function () {
        location.href = "form_reverse_kontrabon.php";
    };
</script>

<script type="text/javascript">
    document.getElementById('reset').onclick = function () {
        location.href = "reverse_kontrabon.php";
    };
</script>
