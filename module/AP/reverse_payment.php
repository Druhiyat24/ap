...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fas fa-history"></i> REVERSE PAYMENT</h5>
</div>

<div class="card-body p-3">
  <form id="form-data" action="reverse_payment.php" method="post">
    <div class="row g-3">
      <!-- Supplier -->
      <div class="col-md-4">
...
<div class="card shadow border-0 mt-4">
    <div class="card-body p-4">
      ...
      <tbody>
        ...
        $sql = mysqli_query($conn2,"select rvs_number, rvs_date, type_doc, deskripsi, status, created_by, created_date from ap_reverse_h where rvs_date BETWEEN '$start_date' AND '$end_date' and rvs_number like '%PAY%' $where");
...
<script type="text/javascript">
    document.getElementById('btncreate').onclick = function () {
        location.href = "form_reverse_payment.php";
    };
</script>

<script type="text/javascript">
    document.getElementById('reset').onclick = function () {
        location.href = "reverse_payment.php";
    };
</script>
