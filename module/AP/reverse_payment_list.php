...
<div class="container-fluid mt-4 p-4">
  ...
  <div class="card shadow border-0">
    ...
    <h5 class="mb-0"><i class="fas fa-history"></i> REVERSE PAYMENT LIST</h5>
</div>

<div class="card-body p-3">
  <form id="form-data" action="reverse_payment_list.php" method="post">
    <div class="row g-3">
      ...
      <div class="col-md-2 d-flex align-items-end">
        ...
        <?php
        $querys = mysqli_query($conn2,"select menurole.id as id from useraccess inner join menurole on menurole.menu = useraccess.menu where username = '$user' and useraccess.menu = 'Create Reverse Payment List'");
...
<div class="card shadow border-0 mt-4">
    <div class="card-body p-4">
      ...
      <tbody>
        ...
        $sql = mysqli_query($conn2,"SELECT rvs_number, rvs_date, deskripsi, status, created_by, created_date FROM ap_reverse_h WHERE rvs_number LIKE 'RVS/PL/%' AND rvs_date BETWEEN '$start_date' AND '$end_date' $where");
            ...
            <table class="table table-striped table-bordered table-sm" style="font-size:12px;text-align:center;">
              <thead>
                <tr class="text-white" style="background-color:#1E3A8A;">
                  ...
                  <th style="text-align:left;">Description PL</th>
                  <th>Status</th>
...
<?php if(!empty($id_create) && $id_create == '123'): ?>
<script type="text/javascript">
document.getElementById('btncreate').onclick = function () {
    location.href = 'form_reverse_payment_list.php';
};
</script>
<?php endif; ?>
