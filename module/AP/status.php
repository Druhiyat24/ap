...
//    echo $kondisi;
            if ($filter == 'tgl_bpb') {
                if(empty($nama_supp) and empty($start_date) and empty($end_date)){
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where a.tgl_bpb = '$date_now' group by a.no_bpb");
                }
                elseif ($nama_supp == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp group by a.no_bpb");
                }
                elseif ($nama_supp == 'ALL' and !empty($start_date) and !empty($end_date)) {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where a.tgl_bpb between '$start_date' and '$end_date' group by a.no_bpb");
                }    
                elseif ($nama_supp != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where supp = '$nama_supp' group by a.no_bpb");
                }
                else{
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where supp = '$nama_supp' and a.tgl_bpb between '$start_date' and '$end_date' group by a.no_bpb");
                }

            }elseif ($filter == 'tgl_kbon') {
                if(empty($nama_supp) and empty($start_date) and empty($end_date)){
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where a.tgl_kbon = '$date_now' group by a.no_bpb");
                }
                elseif ($nama_supp == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp group by a.no_bpb");
                }
                elseif ($nama_supp == 'ALL' and !empty($start_date) and !empty($end_date)) {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where a.tgl_kbon between '$start_date' and '$end_date' group by a.no_bpb");
                }    
                elseif ($nama_supp != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where supp = '$nama_supp' group by a.no_bpb");
                }
                else{
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where supp = '$nama_supp' and a.tgl_kbon between '$start_date' and '$end_date' group by a.no_bpb");
                }

            }elseif ($filter == 'tgl_lp') {
                if(empty($nama_supp) and empty($start_date) and empty($end_date)){
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where tgl_lp = '$date_now' group by a.no_bpb");
                }
                elseif ($nama_supp == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp group by a.no_bpb");
                }
                elseif ($nama_supp == 'ALL' and !empty($start_date) and !empty($end_date)) {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where tgl_lp between '$start_date' and '$end_date' group by a.no_bpb");
                }    
                elseif ($nama_supp != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where supp = '$nama_supp' group by a.no_bpb");
                }
                else{
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where supp = '$nama_supp' and tgl_lp between '$start_date' and '$end_date' group by a.no_bpb");
                }

            }else{
                if(empty($nama_supp) and empty($start_date) and empty($end_date)){
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where tgl_pay = '$date_now' group by a.no_bpb");
                }
                elseif ($nama_supp == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp group by a.no_bpb");
                }
                ...
                elseif ($nama_supp != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
                    ...
                    $sql = mysqli_query($conn2,"select a.id, supp, a.no_bpb, a.tgl_bpb, a.no_kbon, a.tgl_kbon, no_lp, tgl_lp, no_pay, tgl_pay, DATE_FORMAT(b.confirm_date, '%Y-%m-%d') tgl_approve_lp,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp from status a left join list_payment b on b.no_payment  = a.no_lp where supp = '$nama_supp' and tgl_pay between '$start_date' and '$end_date' group by a.no_bpb");
                }
            }   

// ,tgl_approve_bpb, tgl_approve_kbon, tgl_approve_lp, tgl_closing_lp
            while($row = mysqli_fetch_array($sql)){
