...
select no_pay no_journal, no_coa,nama_coa from saldo_awal where no_coa != '' and no_pay = '$no_payment') a left join mastercoa_v2 b on b.no_coa = a.no_coa");
        ...
        $relasi = isset($rowcoa['relasi']) ? $rowcoa['relasi'] : null;
             ...
             $queryin = "INSERT INTO rpt_ap_lp (nama_supp,no_payment,tgl_payment,due_date,curr,beg_balance,addition,deduction,end_balance,create_date,due_0,due_1,due_2,due_3,due_4,due_5,due_6,due_7,due_total,produe_0,produe_1,produe_2,produe_3,produe_4,produe_5,produe_6,produe_total,filter_awal,filter_akhir,no_coa,item_type1,item_type2,relasi) 
                        VALUES 
                    ('$suppin3', '$paymentin', '$tgl_paymentin', '$due_date3', '$currin3', '$sa_awal', '$tambah', '$kurang', '$sa_akhir', '$insert_date', '$due_current', '$due_1', '$due_2', '$due_3', '$due_4', '$due_5', '$due_6', '$due_7', '$tot_due', '$pro_due', '$pro_due0', '$pro_due1', '$pro_due2', '$pro_due3', '$pro_due4', '$pro_due5', '$tot_produe', '$start_date', '$end_date', '$no_coa', '$item_type1', '$item_type2', '$relasi')";
