...
$query = "update whs_bppb_det a
INNER JOIN (select a.no_bppb,id_roll, a.curr curr_out, price_in price_out, b.curr, price_idr price_upt, (price_in - price_idr) diff from (select a.* from whs_bppb_det a INNER JOIN whs_bppb_h b on b.no_bppb = a.no_bppb where tgl_bppb >= '2024-12-01') a left join (
