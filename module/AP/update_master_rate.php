...
VALUES 
    ('$id', '$create_user', 'EDIT', '$last_update')";
...
try {
    ...
    mysqli_query($conn2, "INSERT INTO cancel_masterrate 
        SELECT * FROM masterrate WHERE v_idgroup = '$id'");

    mysqli_query($conn2, "INSERT INTO cancel_ap_masterrate 
        SELECT * FROM ap_masterrate WHERE v_idgroup = '$id'");
