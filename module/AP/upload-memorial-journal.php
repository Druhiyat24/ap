...
<div class="col p-4">
    ...
    <div class="box">
        <div class="box header">
          ...
          $sql = mysqli_query($conn2,"select LPAD(COALESCE(MAX(CAST(RIGHT(no_mj, 5) AS UNSIGNED)), 0) + 0,5,'0') no_mj from tbl_memorial_journal where MONTH(mj_date) = MONTH('$txt_periode') and YEAR(mj_date) = YEAR('$txt_periode')");
          ...
          $sql_sb = mysqli_query($conn2,"select LPAD(COALESCE(MAX(CAST(RIGHT(no_mj, 5) AS UNSIGNED)), 0) + 0,5,'0') no_mj from sb_memorial_journal where MONTH(mj_date) = MONTH('$txt_periode') and YEAR(mj_date) = YEAR('$txt_periode')");
